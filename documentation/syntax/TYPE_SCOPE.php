...
<html>
	...
	<body>
		...
		<div class="syntax">
			<p>syntax</p>
			<div>{<a href="/documentation/syntax/IC.php">IC</a>} {<a href="/documentation/syntax/TYPE_STATEMENT.php">TYPE_STATEMENT</a> {<a href="/documentation/syntax/IC.php">IC</a>}}</div>
		</div>
		<h2>Notes</h2>
