...
style="font-size:13.3333px;line-height:21.3333px">
        creates a nullary void function that executes a given code block repeatedly, over the elements specified by the specified denumerable
    </div>
    <div style="font-size:13.3333px;line-height:21.3333px;margin-top:12pt;margin-bottom:12pt;border-style:solid;border-width:1px">
        ...
        <pre style="margin-top:0px;margin-bottom:0px;padding:3px;font-family:Courier New;width:715px;max-height:500px;overflow:auto">
            ...
            <a style="font-size:13.3333px;line-height:21.3333px;background-color:transparent" href="statement_scope.php">
                statement_scope
            </a>
        </pre>
    </div>
