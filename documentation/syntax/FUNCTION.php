...
<html>
	...
	<body>
		...
		<div class="syntax">
			<p>syntax</p>
			<div>["("  [<a href="/documentation/syntax/PARAMETER.php">PARAMETER</a> {","  <a href="/documentation/syntax/PARAMETER.php">PARAMETER</a>}] ")"] [<a href="/documentation/syntax/FUNCTION_MODIFIER_0.php">FUNCTION_MODIFIER_0</a>] <a href="/documentation/syntax/BLOCK.php">BLOCK</a></div>
		</div>
		<div class="code2">
			<p>Example</p>
			<pre>
