...
<html>
	...
	<body>
		...
		<div class="syntax">
			<p>syntax</p>
			<div>"for"  "("  [(<a href="/documentation/syntax/STATEMENT_SCOPE.php">STATEMENT_SCOPE</a>)] (<a href="/documentation/syntax/EXPRESSION.php">EXPRESSION</a>)  ";"  [<a href="/documentation/syntax/ASSIGNMENT_CHAIN.php">ASSIGNMENT_CHAIN</a> {","  <a href="/documentation/syntax/ASSIGNMENT_CHAIN.php">ASSIGNMENT_CHAIN</a>}] ")"  <a href="/documentation/syntax/EXPRESSION.php">EXPRESSION</a></div>
		</div>
		<div class="code2">
			<p>Example</p>
			<pre>
