...
<html>
	...
	<body>
		...
		<div class="syntax">
			<p>syntax</p>
			<div>[XML_DOC_STRING {IC}] ["extern" {IC}] (TYPE_DEREFERENCE | IMPLICIT_TYPE_DEREFERENCE | VOLATILE_IMPLICIT_TYPE_DEREFERENCE | VOLATILE_TYPE_DEREFERENCE) {IC} DECLARATION_PART {{IC} "," {IC} DECLARATION_PART}</div>
		</div>
		<div class="code">
			<p>Example</p>
