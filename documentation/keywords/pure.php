...
<html>
	...
	<body>
		...
		<p>when used in the <a href="../syntax.php?name=FUNCTION">function</a> syntax, indicates that the implementation's behavior meets the requirements of a pure function</p>
		<div class="code2">
			<p>Example</p>
			<pre>
