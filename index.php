...
<html lang="en-us">
	...
	<body>
		...
		<p>
		I was born at the cusp of the Millenial generation. I remember my parent's early home computers, and the seminal communities that arose in the twilight of the World Wide Web. I received my first cell phone as a mid-teen, when access to the internet was distributed on physical CDs, printed in millions. Today, we are connected by technology so powerful as to deeply transform the human condition in the span of a single generation. Our voices have become multiplied, and divided. Our individual experiences have become the shared experiences of the world. Our thoughts, in a gesture, have become actions. This change, though unprecedented, is the exponential growth of science and technology predicted long ago, and long manifested. Modern, young minds see inspiration and opportunity in pursuit of a new future. A command of our modern world is desirable both professionally, and personally-the once arcane knowledge of the venerable ancients is, in a word, cool!</p>

		<p>As more of us master the way in which we build our new experiences-programming, making, and collaboration-a measure of caution is warranted. We see that our haste to embrace these new ideas has left us compromised and vulnerable. Citizens are defrauded by nefarious agents, goverments are swayed by global propaganda, and the rise of the artificially intelligent may serve to decimate the middle class. As a practitioner of engineering, and a lifelong student of the application of critical thinking and problem solving, I feel it's my duty to work diligently and purposefully to prevent the abuse of careless mistakes. Compromised technologies and paradigms are not justifiable means to quick ends. Rigorous, and transparent application of the best engineering practices are essential to a sound global software infrastructure. Like with medical devices, bridges, and clean water, we should accept no failure in the systems essential to our modern way of living. The teething infant of computational science and engineering is no different, and has very big shoes to fill.</p>

		<p>I am privileged to witness the explosive development of human intellectual endeavor, and I aspire to build an ecosystem of technology that is safe, fair, sophisticated, and for the benefit of all. I ask you to join me.</p>
