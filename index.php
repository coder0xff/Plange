...
<html lang="en-us">
	...
	<body>
		...
		<p>
		I was born at the cusp of the Millenial generation. I remember my parent's early home computers, and the seminal communities that arose in the dusk of the World Wide Web. I received my first cell phone as a mid-teen, when access to the internet was distributed on physical CDs, printed in millions. Today, we are connected by technology so powerful as to deeply transform the human condition in the span of a single generation. Our voices have become multiplied, and divided. Our individual experiences have become the shared experiences of the world. Our thoughts, in a gesture, have become actions. This change, though unprecedented, is the exponential growth of science and technology predicted long ago, and long manifested. Modern, young minds see inspiration and opportunity to find purpose in a new future. A command of our modern world is desirable both professionally, and personally-the once arcane knowledge of the venerable ancients is, in a word, cool!</p>
