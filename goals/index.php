<meta charset='utf-8'/><html><head><title>index.html</title><link rel=StyleSheet href='../css/general.css' type='text/css' /></head><body><?php require('../header.php') ?>
    ...
    <a href="strongly-connected-model-of-computation.php">
        main page
    </a>
    .
    <h2>
        <a href="first-classing.php">
            First Classing
        </a>
    </h2>
    <p>
    ...
    <p>
        ...
        <a href="../../../external.php?link=https://en.wikipedia.org/wiki/Programming_language_generations" rel="nofollow">
    ...
    <p>
      ...
      the integration of
        <a href="../../../external.php?link=http://www.sagemath.org/" rel="nofollow">
            SageMath
        </a>
        and SAT solving into the tool chain.
    </p>
    <h2>
        Scripting friendly
    </h2>
    <div>
      ...
      translation unit. See:
        <a href="../documentation/standard-library.php">
            Standard Library
        </a>
        &nbsp;Further, the bar to entry must be low for provisioning
    ...
    <div>
        ...
        See:
            <a href="../documentation/keywords/asm.php">
                asm
            </a>
        </p>
        <h2>
        ...
        a moderated platform for open-source user contributions.
        </p>
        <h2>
            Communicate Well
        </h2>
        <p>
            Documentation is exhaustive, generated wherever possible, and
