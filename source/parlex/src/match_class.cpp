...
match_class::match_class(size_t const documentPosition, size_t const recognizerIndex) : document_position(documentPosition), recognizer_index(recognizerIndex) {
}
