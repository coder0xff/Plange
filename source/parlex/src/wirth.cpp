...
namespace {
    ...
    int build() {
        ...
        whiteSpaceDfa.add_transition(0, space, 0);
        whiteSpaceDfa.add_transition(0, newline, 0);
        ...
        expressionDfa.add_transition(1, whiteSpaceDfa, 2);
        expressionDfa.add_transition(2, pipe, 3);
        expressionDfa.add_transition(3, whiteSpaceDfa, 4);

        termDfa.add_transition(0, factorDfa, 2);
        termDfa.add_transition(2, whiteSpaceDfa, 1);
        termDfa.add_transition(1, factorDfa, 2);
