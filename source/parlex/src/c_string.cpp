...
parlex::state_machine octal_escape_sequence("octal_escape_sequence", 0, 3, &parlex::builtins::longest);
parlex::state_machine hex_escape_sequence("hex_escape_sequence", 0, 1, &parlex::builtins::longest);
