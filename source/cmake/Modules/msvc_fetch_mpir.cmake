...
function(msvc_fetch_mpir)
	if(${MSVC})
		...
		set(MPIR_PDB_OUT "${MPIR_INSTALL_DIR}\\mpir.pdb")
		set(GMP_INCLUDE_DIRS "${MPIR_INSTALL_DIR}")
		if(NOT EXISTS "${MPIR_INC_OUT}" OR NOT EXISTS "${MPIR_LIB_OUT}" OR NOT EXISTS "${MPIR_PDB_OUT}")
			...
			set(MPIR_SLN_PDB "${MPIR_SLN_OUT_DIR}\\mpir.pdb")
			if (NOT EXISTS "${MPIR_SLN_INC}" OR NOT EXISTS "${MPIR_SLN_LIB}" OR NOT EXISTS "${MPIR_SLN_PDB}")
				if(NOT IS_DIRECTORY "${MPIR_SOURCE_DIR}")
					...
					if(NOT EXISTS "${MPIR_DL_LOCATION}")
						set(MPIR_DL_SERVER "https://web.archive.org/web/20160617183355/http://mpir.org")
				...
				message(INFO "${MPIR_SLN_DIR}\\msbuild.bat")
			...
			file(COPY "${MPIR_SLN_PDB}" DESTINATION "${MPIR_INSTALL_DIR}")
		endif()

		set(GMP_INCLUDE_DIRS "${GMP_INCLUDE_DIRS}" PARENT_SCOPE)
		set(GMP_LIBRARIES "${MPIR_LIB_OUT}" PARENT_SCOPE)
	endif()
endfunction()
