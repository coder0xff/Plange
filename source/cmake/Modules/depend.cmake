...
function(prep_dependency DL_URL EXTENSION DEP_NAME CONFIG_CMAKE_RELATIVE_PATH INCLUDE_OUT)
	...
	if (NOT EXISTS "${DEP_CONFIG_FILE}")
		...
		if (NOT EXISTS "${DEP_BINARY_DIR}/${DEP_NAME}.sln")
			...
			execute_process(COMMAND "${CMAKE_COMMAND}" "${UNPACK_DIR}" "-G" "${CMAKE_GENERATOR}" "-DCMAKE_INSTALL_PREFIX=${DEP_INSTALL_DIR}" WORKING_DIRECTORY "${DEP_BINARY_DIR}")
		endif()
...
macro(depend DEP_NAME DL_URL EXTENSION CONFIG_CMAKE_RELATIVE_PATH)
	message(STATUS "Searching for ${DEP_NAME}")
	find_package(${DEP_NAME} CONFIG QUIET)
	if (NOT ${${DEP_NAME}_FOUND})	
		prep_dependency("${DL_URL}" "${EXTENSION}" "${DEP_NAME}" "${CONFIG_CMAKE_RELATIVE_PATH}" INCLUDE_OUT)
		find_package(${DEP_NAME} CONFIG QUIET)
		if (NOT ${${DEP_NAME}_FOUND})	
			include(${INCLUDE_OUT})
		endif()
