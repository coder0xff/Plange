...
#include "IC.hpp"
plc::VOLATILE_TYPE_DEREFERENCE plc::VOLATILE_TYPE_DEREFERENCE::build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n) {
	auto const & children = b.get_children();
	return VOLATILE_TYPE_DEREFERENCE(
