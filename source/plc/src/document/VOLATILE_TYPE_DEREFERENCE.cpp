...
plc::VOLATILE_TYPE_DEREFERENCE plc::VOLATILE_TYPE_DEREFERENCE::build(parlex::details::ast_node const & n) {
	...
	auto v_6 = parlex::details::document::element<parlex::details::document::text<literal_0x3E_t>>::build(&*children[6], w);
...
parlex::details::recognizer const & plc::VOLATILE_TYPE_DEREFERENCE::recognizer() {
