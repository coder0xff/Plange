...
plc::OR_ASSIGNMENT plc::OR_ASSIGNMENT::build(parlex::detail::ast_node const & n) {
	...
	return OR_ASSIGNMENT(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2), std::move(v3), std::move(v4), std::move(v5));
}
