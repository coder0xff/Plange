...
plc::EQUALITY plc::EQUALITY::build(parlex::detail::ast_node const & n) {
	...
	return EQUALITY(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2));
}
