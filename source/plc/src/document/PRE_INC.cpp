...
plc::PRE_INC plc::PRE_INC::build(parlex::details::ast_node const & n) {
	static auto const * b = &plange_grammar::get().PRE_INC.get_behavior();
	parlex::details::document::walk w{ n.children.cbegin(), n.children.cend() };
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<parlex::details::document::text<literal_0x2B0x2B_t>>::build(&*children[0], w);
...
parlex::details::recognizer const & plc::PRE_INC::recognizer() {
