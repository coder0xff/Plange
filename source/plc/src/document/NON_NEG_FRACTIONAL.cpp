...
plc::NON_NEG_FRACTIONAL_1_t plc::NON_NEG_FRACTIONAL_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	...
	auto v_2 = parlex::detail::document::element<parlex::detail::document::text<literal_0x2E_t>>::build(&*children[2], w);
	auto v_3 = parlex::detail::document::element<std::vector<parlex::detail::document::text<parlex::detail::decimal_digit_t>>>::build(&*children[3], w);
	return NON_NEG_FRACTIONAL_1_t(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3));
}

plc::NON_NEG_FRACTIONAL_2_t plc::NON_NEG_FRACTIONAL_2_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
...
parlex::detail::recognizer const & plc::NON_NEG_FRACTIONAL::recognizer() {
