...
plc::NOT_HAS plc::NOT_HAS::build(parlex::details::ast_node const & n) {
	...
	auto v_2 = parlex::details::document::element<std::variant<
		parlex::details::document::text<literal_0xE20x880x8C_t>,
		parlex::details::document::text<literal_0x2Fhas_t>
	>>::build(&*children[2], w);
...
parlex::details::recognizer const & plc::NOT_HAS::recognizer() {
