...
plc::SUBSET_CHAIN_LOOP::field_4_t_1_t plc::SUBSET_CHAIN_LOOP::field_4_t_1_t::build(parlex::details::behavior::node const * b, parlex::details::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
	auto v_1 = parlex::details::document::element<erased<SUBSET_CHAIN_LOOP>>::build(&*children[1], w);
	return field_4_t_1_t(std::move(v_0), std::move(v_1));
}

plc::SUBSET_CHAIN_LOOP plc::SUBSET_CHAIN_LOOP::build(parlex::details::ast_node const & n) {
	...
	auto v_0 = parlex::details::document::element<std::variant<
		...
		parlex::details::document::text<literal_0xE20x8A0x86_t>,
		parlex::details::document::text<literal_subs_t>,
		parlex::details::document::text<literal_0xE20x8A0x82_t>,
		parlex::details::document::text<literal_psubs_t>
	>>::build(&*children[0], w);
...
parlex::details::recognizer const & plc::SUBSET_CHAIN_LOOP::recognizer() {
