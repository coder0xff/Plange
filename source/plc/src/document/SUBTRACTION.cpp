...
plc::SUBTRACTION plc::SUBTRACTION::build(parlex::detail::ast_node const & n) {
	...
	auto v_2 = parlex::detail::document::element<parlex::detail::document::text<literal_0x2D_t>>::build(&*children[2], w);
...
parlex::detail::recognizer const & plc::SUBTRACTION::recognizer() {
