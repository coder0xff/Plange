...
plc::TYPE_CONSTRAINT plc::TYPE_CONSTRAINT::build(std::u32string const & document, parlex::details::ast_node const & n) {
	...
	auto v_2 = parlex::details::document::element<erased<TYPE_CONSTRAINT_CHAIN>>::build(document, *children[2], w);
