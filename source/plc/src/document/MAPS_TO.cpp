...
plc::MAPS_TO plc::MAPS_TO::build(parlex::details::ast_node const & n) {
	...
	auto v_2 = parlex::details::document::element<std::variant<
		parlex::details::document::text<literal_0xE20x860x92_t>,
		parlex::details::document::text<literal_0x2D0x3E_t>
	>>::build(&*children[2], w);
...
parlex::details::recognizer const & plc::MAPS_TO::recognizer() {
