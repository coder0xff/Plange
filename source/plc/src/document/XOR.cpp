...
plc::XOR plc::XOR::build(parlex::details::ast_node const & n) {
	...
	auto v_2 = parlex::details::document::element<std::variant<
		parlex::details::document::text<literal_0xE20x8A0x95_t>,
		parlex::details::document::text<literal_xor_t>
	>>::build(&*children[2], w);
...
parlex::details::recognizer const & plc::XOR::recognizer() {
