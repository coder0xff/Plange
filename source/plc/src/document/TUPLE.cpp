...
plc::TUPLE::field_3_t_1_t plc::TUPLE::field_3_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
...
plc::TUPLE plc::TUPLE::build(parlex::detail::ast_node const & n) {
	...
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<parlex::detail::document::text<literal_0x280x7C_t>>::build(&*children[0], w);
	...
	auto v_3 = parlex::detail::document::element<std::vector<field_3_t_1_t>>::build(&*children[3], w);
	auto v_4 = parlex::detail::document::element<std::vector<erased<IC>>>::build(&*children[4], w);
	auto v_5 = parlex::detail::document::element<parlex::detail::document::text<literal_0x7C0x29_t>>::build(&*children[5], w);
	return TUPLE(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3), std::move(v_4), std::move(v_5));
}


parlex::detail::recognizer const & plc::TUPLE::recognizer() {
