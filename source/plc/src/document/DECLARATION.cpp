...
parlex::detail::state_machine const & plc::DECLARATION::state_machine() {
	static auto const & result = *static_cast<parlex::detail::state_machine const *>(&plange_grammar::get().get_recognizer(plange_grammar::get().DECLARATION));
	return result;
}
