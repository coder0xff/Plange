...
plc::DECLARATION::field_1_t_1_t plc::DECLARATION::field_1_t_1_t::build(parlex::details::behavior::node const * b, parlex::details::document::walk & w) {
...
plc::DECLARATION plc::DECLARATION::build(parlex::details::ast_node const & n) {
...
parlex::details::recognizer const & plc::DECLARATION::recognizer() {
