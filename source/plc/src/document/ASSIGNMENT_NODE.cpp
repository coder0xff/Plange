...
plc::ASSIGNMENT_NODE::value_t plc::ASSIGNMENT_NODE::value_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::ASSIGNMENT_NODE plc::ASSIGNMENT_NODE::build(parlex::detail::ast_node const & n) {
	...
	auto v2 = parlex::detail::document::element<std::variant<
		...
		value_t
	>>::build(&*children[2], w);
	return ASSIGNMENT_NODE(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2));
}
