...
plc::PREPEND plc::PREPEND::build(parlex::detail::ast_node const & n) {
	...
	auto v_2 = parlex::detail::document::element<parlex::detail::document::text<literal_0x26_t>>::build(&*children[2], w);
...
parlex::detail::recognizer const & plc::PREPEND::recognizer() {
