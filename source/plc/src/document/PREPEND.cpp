...
plc::PREPEND plc::PREPEND::build(std::u32string const & document, parlex::details::ast_node const & n) {
	...
	return PREPEND(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3));
}
