...
plc::EMBEDDED_COMMENT_INTERIOR_1_t plc::EMBEDDED_COMMENT_INTERIOR_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
...
parlex::detail::recognizer const & plc::EMBEDDED_COMMENT_INTERIOR::recognizer() {
