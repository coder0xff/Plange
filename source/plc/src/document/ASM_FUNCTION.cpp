...
plc::ASM_FUNCTION::field_1_t_1_t::field_2_t_1_t::field_1_t_1_t plc::ASM_FUNCTION::field_1_t_1_t::field_2_t_1_t::field_1_t_1_t::build(std::u32string const & document, parlex::details::behavior::node const & b, parlex::details::document::walk & w) {
...
plc::ASM_FUNCTION::field_1_t_1_t::field_2_t_1_t plc::ASM_FUNCTION::field_1_t_1_t::field_2_t_1_t::build(std::u32string const & document, parlex::details::behavior::node const & b, parlex::details::document::walk & w) {
	auto const & children = b.get_children();
...
plc::ASM_FUNCTION::field_1_t_1_t plc::ASM_FUNCTION::field_1_t_1_t::build(std::u32string const & document, parlex::details::behavior::node const & b, parlex::details::document::walk & w) {
	auto const & children = b.get_children();
	assert(w.pos != w.end); ++w.pos; //( 
...
plc::ASM_FUNCTION plc::ASM_FUNCTION::build(std::u32string const & document, parlex::details::ast_node const & n) {
	...
	auto v_1 = parlex::details::document::element<std::optional<erased<FUNCTION_MODIFIER_0>>>::build(document, *children[1], w);
	assert(w.pos != w.end); ++w.pos; //asm 
	auto v_2 = parlex::details::document::element<std::vector<erased<IC>>>::build(document, *children[3], w);
	assert(w.pos != w.end); ++w.pos; //{ 
	auto v_3 = parlex::details::document::element<erased<ASM_SCOPE>>::build(document, *children[5], w);
	assert(w.pos != w.end); ++w.pos; //} 
	return ASM_FUNCTION(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3));
}
