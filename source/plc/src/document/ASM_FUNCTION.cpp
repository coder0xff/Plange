...
plc::ASM_FUNCTION::field_1_t_1_t::field_2_t_1_t::field_1_t_1_t plc::ASM_FUNCTION::field_1_t_1_t::field_2_t_1_t::field_1_t_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::ASM_FUNCTION::field_1_t_1_t::field_2_t_1_t plc::ASM_FUNCTION::field_1_t_1_t::field_2_t_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->children;
...
plc::ASM_FUNCTION::field_1_t_1_t plc::ASM_FUNCTION::field_1_t_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->children;
...
plc::ASM_FUNCTION plc::ASM_FUNCTION::build(parlex::detail::ast_node const & n) {
	...
	auto v1 = parlex::detail::document::element<std::optional<erased<FUNCTION_MODIFIER_0>>>::build(&*children[1], w);
	...
	auto v5 = parlex::detail::document::element<erased<ASM_SCOPE>>::build(&*children[5], w);
	auto v6 = parlex::detail::document::element<parlex::detail::document::text<literal_0x7D_t>>::build(&*children[6], w);
	return ASM_FUNCTION(std::move(v0), std::move(v1), std::move(v2), std::move(v3), std::move(v4), std::move(v5), std::move(v6));
}


parlex::detail::state_machine const & plc::ASM_FUNCTION::state_machine() {
	static auto const & result = *static_cast<parlex::detail::state_machine const *>(&plange_grammar::get().get_recognizer(plange_grammar::get().ASM_FUNCTION));
	return result;
}
