...
plc::FOR_STEP plc::FOR_STEP::build(parlex::detail::ast_node const & n) {
	...
	return FOR_STEP(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2));
}
