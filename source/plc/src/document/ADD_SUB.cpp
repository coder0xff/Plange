...
plc::ADD_SUB plc::ADD_SUB::build(parlex::details::ast_node const & n) {
	...
	auto v_2 = parlex::details::document::element<std::variant<
		parlex::details::document::text<literal_0xC20xB1_t>,
		parlex::details::document::text<literal_0x2B0x2D_t>
	>>::build(&*children[2], w);
...
parlex::details::recognizer const & plc::ADD_SUB::recognizer() {
	return plange_grammar::get().ADD_SUB.get_recognizer();
}
