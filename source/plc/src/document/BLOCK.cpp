...
parlex::detail::state_machine const & plc::BLOCK::state_machine() {
	static auto const & result = *static_cast<parlex::detail::state_machine const *>(&plange_grammar::get().get_recognizer(plange_grammar::get().BLOCK));
	return result;
}
