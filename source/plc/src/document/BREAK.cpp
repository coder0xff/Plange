...
plc::BREAK::field_1_t_1_t_1_t plc::BREAK::field_1_t_1_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
...
plc::BREAK::field_1_t_1_t_2_t plc::BREAK::field_1_t_1_t_2_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
...
plc::BREAK plc::BREAK::build(parlex::detail::ast_node const & n) {
	...
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<parlex::detail::document::text<literal_break_t>>::build(&*children[0], w);
...
parlex::detail::recognizer const & plc::BREAK::recognizer() {
