...
plc::RETURN::field_1_t plc::RETURN::field_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::RETURN::field_2_t plc::RETURN::field_2_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->children;
	auto v0 = parlex::detail::document::element<std::vector<val<IC>>>::build(&*children[0], w);
...
plc::RETURN plc::RETURN::build(parlex::detail::ast_node const & n) {
	...
	return RETURN(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2));
}
