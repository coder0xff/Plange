...
plc::FUNCTION_MODIFIER_MODEL::field_1_t plc::FUNCTION_MODIFIER_MODEL::field_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::FUNCTION_MODIFIER_MODEL plc::FUNCTION_MODIFIER_MODEL::build(parlex::detail::ast_node const & n) {
	...
	return FUNCTION_MODIFIER_MODEL(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1));
}
