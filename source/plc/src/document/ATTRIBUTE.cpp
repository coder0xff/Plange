...
plc::ATTRIBUTE plc::ATTRIBUTE::build(parlex::detail::ast_node const & n) {
	...
	auto v_4 = parlex::detail::document::element<parlex::detail::document::text<literal_0x40_t>>::build(&*children[4], w);
	return ATTRIBUTE(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3), std::move(v_4));
}


parlex::detail::recognizer const & plc::ATTRIBUTE::recognizer() {
