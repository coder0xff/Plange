...
plc::DOT_PRODUCT plc::DOT_PRODUCT::build(parlex::details::ast_node const & n) {
	...
	auto v_2 = parlex::details::document::element<std::variant<
		parlex::details::document::text<literal_0xE20x8B0x85_t>,
		parlex::details::document::text<literal__dot__t>
	>>::build(&*children[2], w);
...
parlex::details::recognizer const & plc::DOT_PRODUCT::recognizer() {
