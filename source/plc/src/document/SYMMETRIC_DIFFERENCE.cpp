...
plc::SYMMETRIC_DIFFERENCE plc::SYMMETRIC_DIFFERENCE::build(parlex::details::ast_node const & n) {
	...
	auto v_2 = parlex::details::document::element<parlex::details::document::text<literal_0xE20x8A0x96_t>>::build(&*children[2], w);
...
parlex::details::recognizer const & plc::SYMMETRIC_DIFFERENCE::recognizer() {
