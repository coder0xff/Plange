...
plc::THROW::field_1_t_1_t plc::THROW::field_1_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
...
plc::THROW::field_2_t_1_t plc::THROW::field_2_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
...
plc::THROW plc::THROW::build(parlex::detail::ast_node const & n) {
	...
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<parlex::detail::document::text<literal_throw_t>>::build(&*children[0], w);
...
parlex::detail::recognizer const & plc::THROW::recognizer() {
