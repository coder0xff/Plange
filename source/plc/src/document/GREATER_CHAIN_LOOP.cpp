...
#include "GREATER_CHAIN_LOOP.hpp"
#include "IC.hpp"
plc::GREATER_CHAIN_LOOP::field_3_t_1_t plc::GREATER_CHAIN_LOOP::field_3_t_1_t::build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n) {
...
plc::GREATER_CHAIN_LOOP plc::GREATER_CHAIN_LOOP::build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n) {
	auto const & children = b.get_children();
	return GREATER_CHAIN_LOOP(
		parlex::details::document::element<decltype(field_1)>::build(*children[0], n.children[0]),
