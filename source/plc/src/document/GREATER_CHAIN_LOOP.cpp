...
plc::GREATER_CHAIN_LOOP::field_3_t_1_t plc::GREATER_CHAIN_LOOP::field_3_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
	auto v_1 = parlex::detail::document::element<erased<GREATER_CHAIN_LOOP>>::build(&*children[1], w);
...
parlex::detail::recognizer const & plc::GREATER_CHAIN_LOOP::recognizer() {
