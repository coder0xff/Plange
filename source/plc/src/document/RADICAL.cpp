...
plc::RADICAL plc::RADICAL::build(parlex::details::ast_node const & n) {
	static auto const * b = &plange_grammar::get().RADICAL.get_behavior();
	parlex::details::document::walk w{ n.children.cbegin(), n.children.cend() };
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<parlex::details::document::text<literal_0xE20x880x9A_t>>::build(&*children[0], w);
...
parlex::details::recognizer const & plc::RADICAL::recognizer() {
