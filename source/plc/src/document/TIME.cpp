...
parlex::detail::state_machine const & plc::TIME::state_machine() {
	static auto const & result = *static_cast<parlex::detail::state_machine const *>(&plange_grammar::get().get_recognizer(plange_grammar::get().TIME));
	return result;
}
