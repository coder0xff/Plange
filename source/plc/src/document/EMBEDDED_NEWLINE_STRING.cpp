...
plc::EMBEDDED_NEWLINE_STRING plc::EMBEDDED_NEWLINE_STRING::build(parlex::details::ast_node const & n) {
...
parlex::details::recognizer const & plc::EMBEDDED_NEWLINE_STRING::recognizer() {
