...
plc::ASM_STATEMENT::field_2_t_1_t::field_3_t_1_t::field_2_t_1_t plc::ASM_STATEMENT::field_2_t_1_t::field_3_t_1_t::field_2_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
	auto v_1 = parlex::detail::document::element<erased<ASM_EXPRESSION>>::build(&*children[1], w);
	return field_2_t_1_t(std::move(v_0), std::move(v_1));
}

plc::ASM_STATEMENT::field_2_t_1_t::field_3_t_1_t plc::ASM_STATEMENT::field_2_t_1_t::field_3_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
...
plc::ASM_STATEMENT::field_2_t_1_t plc::ASM_STATEMENT::field_2_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<erased<ICR>>::build(&*children[0], w);
	auto v_1 = parlex::detail::document::element<erased<ASM_EXPRESSION>>::build(&*children[1], w);
	auto v_2 = parlex::detail::document::element<std::vector<field_3_t_1_t>>::build(&*children[2], w);
...
plc::ASM_STATEMENT plc::ASM_STATEMENT::build(parlex::detail::ast_node const & n) {
	...
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<erased<ASM_OP>>::build(&*children[0], w);
	...
	auto v_3 = parlex::detail::document::element<parlex::detail::document::text<literal_0x0A_t>>::build(&*children[3], w);
	return ASM_STATEMENT(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3));
}


parlex::detail::recognizer const & plc::ASM_STATEMENT::recognizer() {
