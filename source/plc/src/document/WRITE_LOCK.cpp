...
plc::WRITE_LOCK plc::WRITE_LOCK::build(parlex::detail::ast_node const & n) {
	...
	auto v_0 = parlex::detail::document::element<parlex::detail::document::text<literal_write_lock_t>>::build(&*children[0], w);
...
parlex::detail::recognizer const & plc::WRITE_LOCK::recognizer() {
