...
plc::NULL_COALESCE plc::NULL_COALESCE::build(parlex::detail::ast_node const & n) {
	...
	auto v_2 = parlex::detail::document::element<parlex::detail::document::text<literal_0x3F0x3F_t>>::build(&*children[2], w);
...
parlex::detail::recognizer const & plc::NULL_COALESCE::recognizer() {
