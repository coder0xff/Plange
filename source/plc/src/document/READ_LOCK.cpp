...
parlex::detail::state_machine const & plc::READ_LOCK::state_machine() {
	static auto const & result = *static_cast<parlex::detail::state_machine const *>(&plange_grammar::get().get_recognizer(plange_grammar::get().READ_LOCK));
	return result;
}
