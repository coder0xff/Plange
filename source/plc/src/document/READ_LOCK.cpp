...
plc::READ_LOCK plc::READ_LOCK::build(parlex::details::ast_node const & n) {
	static auto const * b = &plange_grammar::get().READ_LOCK.get_behavior();
	parlex::details::document::walk w{ n.children.cbegin(), n.children.cend() };
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<parlex::details::document::text<literal_read_lock_t>>::build(&*children[0], w);
...
parlex::details::recognizer const & plc::READ_LOCK::recognizer() {
