...
plc::VECTOR_NORM plc::VECTOR_NORM::build(parlex::details::ast_node const & n) {
	static auto const * b = &plange_grammar::get().VECTOR_NORM.get_behavior();
	parlex::details::document::walk w{ n.children.cbegin(), n.children.cend() };
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<parlex::details::document::text<literal_0x7C0x7C_t>>::build(&*children[0], w);
	...
	auto v_4 = parlex::details::document::element<parlex::details::document::text<literal_0x7C0x7C_t>>::build(&*children[4], w);
	return VECTOR_NORM(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3), std::move(v_4));
}


parlex::details::recognizer const & plc::VECTOR_NORM::recognizer() {
