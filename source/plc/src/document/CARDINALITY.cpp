...
plc::CARDINALITY plc::CARDINALITY::build(parlex::detail::ast_node const & n) {
	...
	auto v_0 = parlex::detail::document::element<parlex::detail::document::text<literal_0x23_t>>::build(&*children[0], w);
...
parlex::detail::recognizer const & plc::CARDINALITY::recognizer() {
