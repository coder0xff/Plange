...
plc::MULTIPLICATION plc::MULTIPLICATION::build(std::u32string const & document, parlex::details::ast_node const & n) {
	...
	return MULTIPLICATION(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3));
}
