...
plc::THIS_TYPE::field_1_t_1_t plc::THIS_TYPE::field_1_t_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::THIS_TYPE plc::THIS_TYPE::build(parlex::detail::ast_node const & n) {
	...
	return THIS_TYPE(std::move(v0), std::move(v1));
}


parlex::detail::state_machine const & plc::THIS_TYPE::state_machine() {
	static auto const & result = *static_cast<parlex::detail::state_machine const *>(&plange_grammar::get().get_recognizer(plange_grammar::get().THIS_TYPE));
	return result;
}
