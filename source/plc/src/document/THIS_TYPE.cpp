...
plc::THIS_TYPE::field_1_t_1_t plc::THIS_TYPE::field_1_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
...
plc::THIS_TYPE plc::THIS_TYPE::build(parlex::detail::ast_node const & n) {
	...
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<parlex::detail::document::text<literal_this_type_t>>::build(&*children[0], w);
...
parlex::detail::recognizer const & plc::THIS_TYPE::recognizer() {
