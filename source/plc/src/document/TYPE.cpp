...
plc::TYPE::field_2_t plc::TYPE::field_2_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::TYPE::field_3_t plc::TYPE::field_3_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->children;
...
plc::TYPE plc::TYPE::build(parlex::detail::ast_node const & n) {
	...
	return TYPE(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2), std::move(v3), std::move(v4), std::move(v5), std::move(v6));
}
