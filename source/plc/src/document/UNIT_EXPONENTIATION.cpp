...
plc::UNIT_EXPONENTIATION plc::UNIT_EXPONENTIATION::build(parlex::details::ast_node const & n) {
	...
	auto v_1 = parlex::details::document::element<parlex::details::document::text<literal_0x5E_t>>::build(&*children[1], w);
...
parlex::details::recognizer const & plc::UNIT_EXPONENTIATION::recognizer() {
