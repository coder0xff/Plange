...
plc::BIT_XOR plc::BIT_XOR::build(std::u32string const & document, parlex::details::ast_node const & n) {
	...
	return BIT_XOR(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3));
}
