...
plc::DEFINITION::field_1_t plc::DEFINITION::field_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::DEFINITION plc::DEFINITION::build(parlex::detail::ast_node const & n) {
	...
	return DEFINITION(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2), std::move(v3), std::move(v4), std::move(v5));
}
