...
plc::ASSIGNMENT_CHAIN::field_1_t_1_t plc::ASSIGNMENT_CHAIN::field_1_t_1_t::build(parlex::details::behavior::node const * b, parlex::details::document::walk & w) {
...
plc::ASSIGNMENT_CHAIN plc::ASSIGNMENT_CHAIN::build(parlex::details::ast_node const & n) {
...
parlex::details::recognizer const & plc::ASSIGNMENT_CHAIN::recognizer() {
