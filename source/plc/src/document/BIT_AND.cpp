...
plc::BIT_AND plc::BIT_AND::build(std::u32string const & document, parlex::details::ast_node const & n) {
	...
	return BIT_AND(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3));
}
