...
plc::TYPE_SCOPE_DECLARATION::field_1_t_1_t plc::TYPE_SCOPE_DECLARATION::field_1_t_1_t::build(std::u32string const & document, parlex::details::behavior::node const & b, parlex::details::document::walk & w) {
...
plc::TYPE_SCOPE_DECLARATION::field_3_t_1_t plc::TYPE_SCOPE_DECLARATION::field_3_t_1_t::build(std::u32string const & document, parlex::details::behavior::node const & b, parlex::details::document::walk & w) {
	auto const & children = b.get_children();
...
plc::TYPE_SCOPE_DECLARATION plc::TYPE_SCOPE_DECLARATION::build(std::u32string const & document, parlex::details::ast_node const & n) {
