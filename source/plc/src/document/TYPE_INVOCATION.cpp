...
plc::TYPE_INVOCATION::field_1_t::argsHead_t_1_t plc::TYPE_INVOCATION::field_1_t::argsHead_t_1_t::build(parlex::details::behavior::node const * b, parlex::details::document::walk & w) {
...
plc::TYPE_INVOCATION::field_1_t::argsTail_t_1_t::field_2_t_1_t plc::TYPE_INVOCATION::field_1_t::argsTail_t_1_t::field_2_t_1_t::build(parlex::details::behavior::node const * b, parlex::details::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
	auto v_1 = parlex::details::document::element<std::variant<
		erased<ARGUMENT>,
...
plc::TYPE_INVOCATION::field_1_t::argsTail_t_1_t plc::TYPE_INVOCATION::field_1_t::argsTail_t_1_t::build(parlex::details::behavior::node const * b, parlex::details::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
...
plc::TYPE_INVOCATION::field_1_t plc::TYPE_INVOCATION::field_1_t::build(parlex::details::behavior::node const * b, parlex::details::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<parlex::details::document::text<literal_0x3C_t>>::build(&*children[0], w);
	auto v_1 = parlex::details::document::element<std::optional<argsHead_t_1_t>>::build(&*children[1], w);
	auto v_2 = parlex::details::document::element<std::vector<argsTail_t_1_t>>::build(&*children[2], w);
...
plc::TYPE_INVOCATION plc::TYPE_INVOCATION::build(parlex::details::ast_node const & n) {
	...
	auto v_1 = parlex::details::document::element<field_1_t>::build(&*children[1], w);
	return TYPE_INVOCATION(std::move(v_0), std::move(v_1));
}


parlex::details::recognizer const & plc::TYPE_INVOCATION::recognizer() {
