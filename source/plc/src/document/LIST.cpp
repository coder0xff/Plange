...
plc::LIST::elements_t_1_t::field_2_t_1_t plc::LIST::elements_t_1_t::field_2_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
	auto v_1 = parlex::detail::document::element<parlex::detail::document::text<literal_0x2C0x20_t>>::build(&*children[1], w);
...
plc::LIST::elements_t_1_t plc::LIST::elements_t_1_t::build(parlex::detail::behavior::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->get_children();
...
plc::LIST plc::LIST::build(parlex::detail::ast_node const & n) {
	static auto const * b = &plange_grammar::get().LIST.get_behavior();
	parlex::detail::document::walk w{ n.children.cbegin(), n.children.cend() };
	auto const & children = b->get_children();
	auto v_0 = parlex::detail::document::element<parlex::detail::document::text<literal_0x5B0x7C_t>>::build(&*children[0], w);
	...
	auto v_3 = parlex::detail::document::element<parlex::detail::document::text<literal_0x7C0x5D_t>>::build(&*children[3], w);
	return LIST(std::move(v_0), std::move(v_1), std::move(v_2), std::move(v_3));
}


parlex::detail::recognizer const & plc::LIST::recognizer() {
