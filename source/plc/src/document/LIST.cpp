...
plc::LIST::elements_t_1_t::field_2_t_1_t plc::LIST::elements_t_1_t::field_2_t_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::LIST::elements_t_1_t plc::LIST::elements_t_1_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->children;
...
plc::LIST plc::LIST::build(parlex::detail::ast_node const & n) {
	...
	return LIST(std::move(v0), std::move(v1), std::move(v2), std::move(v3));
}


parlex::detail::state_machine const & plc::LIST::state_machine() {
	static auto const & result = *static_cast<parlex::detail::state_machine const *>(&plange_grammar::get().get_recognizer(plange_grammar::get().LIST));
	return result;
}
