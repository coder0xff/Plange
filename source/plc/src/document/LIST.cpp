...
plc::LIST::elements_t::field_2_t plc::LIST::elements_t::field_2_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
...
plc::LIST::elements_t plc::LIST::elements_t::build(parlex::detail::node const * b, parlex::detail::document::walk & w) {
	auto const & children = b->children;
...
plc::LIST plc::LIST::build(parlex::detail::ast_node const & n) {
	...
	return LIST(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2), std::move(v3));
}
