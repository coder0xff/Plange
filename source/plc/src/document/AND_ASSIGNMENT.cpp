...
plc::AND_ASSIGNMENT plc::AND_ASSIGNMENT::build(parlex::detail::ast_node const & n) {
	...
	return AND_ASSIGNMENT(std::move(v0), std::move(v1), std::move(v2), std::move(v3), std::move(v4), std::move(v5));
}
