...
plc::SET_COMPREHENSION plc::SET_COMPREHENSION::build(parlex::details::ast_node const & n) {
	...
	auto v_8 = parlex::details::document::element<parlex::details::document::text<literal_0x7D_t>>::build(&*children[8], w);
...
parlex::details::recognizer const & plc::SET_COMPREHENSION::recognizer() {
