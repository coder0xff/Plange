...
plc::NEGATION_ASSIGNMENT plc::NEGATION_ASSIGNMENT::build(parlex::detail::ast_node const & n) {
	...
	>>::build(&*children[3], w);
	return NEGATION_ASSIGNMENT(n.document_position, n.consumed_character_count, std::move(v0), std::move(v1), std::move(v2), std::move(v3));
}
