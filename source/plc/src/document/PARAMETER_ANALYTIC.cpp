...
plc::PARAMETER_ANALYTIC::field_2_t_1_t plc::PARAMETER_ANALYTIC::field_2_t_1_t::build(parlex::details::behavior::node const * b, parlex::details::document::walk & w) {
	auto const & children = b->get_children();
	auto v_0 = parlex::details::document::element<std::vector<erased<IC>>>::build(&*children[0], w);
	auto v_1 = parlex::details::document::element<parlex::details::document::text<literal_0x3D_t>>::build(&*children[1], w);
...
plc::PARAMETER_ANALYTIC plc::PARAMETER_ANALYTIC::build(parlex::details::ast_node const & n) {
...
parlex::details::recognizer const & plc::PARAMETER_ANALYTIC::recognizer() {
