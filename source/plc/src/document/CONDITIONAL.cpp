...
plc::CONDITIONAL plc::CONDITIONAL::build(parlex::details::ast_node const & n) {
	...
	auto v_2 = parlex::details::document::element<parlex::details::document::text<literal_0x3F_t>>::build(&*children[2], w);
...
parlex::details::recognizer const & plc::CONDITIONAL::recognizer() {
