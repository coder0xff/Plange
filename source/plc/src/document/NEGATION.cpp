...
plc::NEGATION plc::NEGATION::build(parlex::detail::ast_node const & n) {
	...
	auto v_0 = parlex::detail::document::element<parlex::detail::document::text<literal_0x2D_t>>::build(&*children[0], w);
...
parlex::detail::recognizer const & plc::NEGATION::recognizer() {
