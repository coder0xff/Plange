...
parlex::grammar const & get_plange() {
	...
	static parlex::state_machine & EMBEDDED_COMMENT = g.add_production("EMBEDDED_COMMENT", 0, 1, &parlex::builtins::super_delimiter, parlex::associativity::none);
	...
	static parlex::state_machine & EMBEDDED_STRING = g.add_production("EMBEDDED_STRING", 0, 1, &parlex::builtins::super_delimiter, parlex::associativity::none);
	static parlex::state_machine & END_OF_LINE_COMMENT = g.add_production("END_OF_LINE_COMMENT", 0, 1, parlex::associativity::none);
	static parlex::state_machine & EQUALITY_CHAIN = g.add_production("EQUALITY_CHAIN", 0, 1, &parlex::builtins::greedy, parlex::associativity::none);
	...
	static parlex::state_machine & GREATER_CHAIN = g.add_production("GREATER_CHAIN", 0, 1, &parlex::builtins::greedy, parlex::associativity::none);
	...
	static parlex::state_machine & LESSER_CHAIN = g.add_production("LESSER_CHAIN", 0, 1, &parlex::builtins::greedy, parlex::associativity::none);
	...
	static parlex::state_machine & SUBSET_CHAIN = g.add_production("SUBSET_CHAIN", 0, 1, &parlex::builtins::greedy, parlex::associativity::none);
	static parlex::state_machine & SUBTRACTION = g.add_production("SUBTRACTION", 0, 1, parlex::associativity::left);
	static parlex::state_machine & SUPERSET_CHAIN = g.add_production("SUPERSET_CHAIN", 0, 1, &parlex::builtins::greedy, parlex::associativity::none);
	...
	static parlex::state_machine & XML_DOC_STRING = g.add_production("XML_DOC_STRING", 0, 1, &parlex::builtins::super_delimiter, parlex::associativity::none);
	...
	oneShot.go([&](){
		...
		ASM_FUNCTION.add_transition(0, literal82, 1);
		ASM_FUNCTION.add_transition(1, IC, 1);
		ASM_FUNCTION.add_transition(1, literal134, 4);
		ASM_FUNCTION.add_transition(2, IC, 2);
		ASM_FUNCTION.add_transition(2, PARAMETER, 5);
		ASM_FUNCTION.add_transition(2, literal14, 6);
		ASM_FUNCTION.add_transition(3, literal82, 1);
		ASM_FUNCTION.add_transition(4, ASM_SCOPE, 7);
		ASM_FUNCTION.add_transition(5, IC, 5);
		ASM_FUNCTION.add_transition(5, literal14, 6);
		ASM_FUNCTION.add_transition(5, literal21, 8);
		ASM_FUNCTION.add_transition(6, FUNCTION_MODIFIER, 3);
		ASM_FUNCTION.add_transition(6, IC, 6);
		ASM_FUNCTION.add_transition(6, literal82, 1);
		ASM_FUNCTION.add_transition(7, literal143, 9);
		...
		ASM_PTR_ARITHMETIC_ATT.add_transition(2, literal46, 3);
		...
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(1, ASM_IDENTIFIER, 3);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(1, literal14, 7);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(1, literal21, 2);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(2, ASM_IDENTIFIER, 4);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(3, literal14, 7);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(3, literal21, 2);
		...
		ASM_PTR_ARITHMETIC_INTEL.add_transition(10, literal18, 5);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(10, literal23, 7);
		...
		ASM_PTR_ARITHMETIC_INTEL.add_transition(3, literal18, 5);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(3, literal23, 7);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(3, literal46, 6);
		...
		ASM_PTR_ARITHMETIC_INTEL.add_transition(8, literal15, 11);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(8, literal18, 7);
		...
		CEILING.add_transition(0, literal137, 2);
		CEILING.add_transition(0, literal182, 1);
		...
		CEILING.add_transition(3, literal183, 5);
		...
		EMBEDDED_STRING.add_transition(1, PAYLOAD, 4);
		EMBEDDED_STRING.add_transition(2, parlex::builtins::not_double_quote, 5);
		EMBEDDED_STRING.add_transition(3, EMBEDDED_STRING, 6);
		EMBEDDED_STRING.add_transition(4, literal1, 7);
		EMBEDDED_STRING.add_transition(5, literal5, 7);
		...
		FUNCTION.add_transition(0, literal12, 2);
		...
		FUNCTION.add_transition(2, literal14, 6);
		FUNCTION.add_transition(3, literal134, 1);
		...
		RANGE.add_transition(0, literal12, 2);
		RANGE.add_transition(0, literal66, 1);
		...
		RANGE.add_transition(2, literal27, 4);
		...
		TYPE.add_transition(1, literal100, 2);
		TYPE.add_transition(1, literal103, 3);
		TYPE.add_transition(1, literal134, 4);
		...
		TYPE.add_transition(4, TYPE_SCOPE, 7);
		TYPE.add_transition(5, IC, 5);
		TYPE.add_transition(5, literal134, 4);
		TYPE.add_transition(6, IC, 6);
		TYPE.add_transition(6, literal100, 2);
		TYPE.add_transition(6, literal134, 4);
		TYPE.add_transition(7, literal143, 8);
		...
		TYPE_SCOPE_DECLARATION.add_transition(0, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(0, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(0, TYPE_SCOPE_DECLARATION_PART, 7);
		TYPE_SCOPE_DECLARATION.add_transition(0, VISIBILITY_MODIFIER, 4);
		TYPE_SCOPE_DECLARATION.add_transition(0, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(0, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(0, XML_DOC_STRING, 3);
		TYPE_SCOPE_DECLARATION.add_transition(0, literal120, 5);
		TYPE_SCOPE_DECLARATION.add_transition(0, literal91, 2);
		...
		TYPE_SCOPE_DECLARATION.add_transition(2, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(2, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(2, TYPE_SCOPE_DECLARATION_PART, 7);
		TYPE_SCOPE_DECLARATION.add_transition(2, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(2, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(3, IC, 3);
		TYPE_SCOPE_DECLARATION.add_transition(3, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(3, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(3, TYPE_SCOPE_DECLARATION_PART, 7);
		TYPE_SCOPE_DECLARATION.add_transition(3, VISIBILITY_MODIFIER, 4);
		TYPE_SCOPE_DECLARATION.add_transition(3, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(3, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(3, literal120, 5);
		TYPE_SCOPE_DECLARATION.add_transition(3, literal91, 2);
		TYPE_SCOPE_DECLARATION.add_transition(4, IC, 4);
		TYPE_SCOPE_DECLARATION.add_transition(4, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(4, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(4, TYPE_SCOPE_DECLARATION_PART, 7);
		TYPE_SCOPE_DECLARATION.add_transition(4, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(4, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(4, literal120, 5);
		TYPE_SCOPE_DECLARATION.add_transition(4, literal91, 2);
		TYPE_SCOPE_DECLARATION.add_transition(5, IC, 5);
		TYPE_SCOPE_DECLARATION.add_transition(5, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(5, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(5, TYPE_SCOPE_DECLARATION_PART, 7);
		TYPE_SCOPE_DECLARATION.add_transition(5, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(5, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DECLARATION.add_transition(5, literal91, 2);
		TYPE_SCOPE_DECLARATION.add_transition(6, IC, 6);
		TYPE_SCOPE_DECLARATION.add_transition(6, TYPE_SCOPE_DECLARATION_PART, 7);
		TYPE_SCOPE_DECLARATION.add_transition(6, XML_DOC_STRING, 1);
		...
		TYPE_SCOPE_DEFINITION.add_transition(0, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(0, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(0, VISIBILITY_MODIFIER, 4);
		TYPE_SCOPE_DEFINITION.add_transition(0, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(0, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(0, XML_DOC_STRING, 3);
		TYPE_SCOPE_DEFINITION.add_transition(0, literal91, 2);
		...
		TYPE_SCOPE_DEFINITION.add_transition(2, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(2, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(2, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(2, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(3, DEFINITION_PART, 6);
		TYPE_SCOPE_DEFINITION.add_transition(3, IC, 3);
		TYPE_SCOPE_DEFINITION.add_transition(3, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(3, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(3, VISIBILITY_MODIFIER, 4);
		TYPE_SCOPE_DEFINITION.add_transition(3, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(3, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(3, literal91, 2);
		TYPE_SCOPE_DEFINITION.add_transition(4, DEFINITION_PART, 6);
		TYPE_SCOPE_DEFINITION.add_transition(4, IC, 4);
		TYPE_SCOPE_DEFINITION.add_transition(4, IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(4, TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(4, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(4, VOLATILE_TYPE_DEREFERENCE, 1);
		TYPE_SCOPE_DEFINITION.add_transition(4, literal91, 2);
		TYPE_SCOPE_DEFINITION.add_transition(5, DEFINITION_PART, 6);
		TYPE_SCOPE_DEFINITION.add_transition(5, IC, 5);
		TYPE_SCOPE_DEFINITION.add_transition(5, XML_DOC_STRING, 1);
		...
		XML_DOC_STRING.add_transition(0, literal78, 2);
		XML_DOC_STRING.add_transition(0, literal79, 1);
		XML_DOC_STRING.add_transition(1, literal79, 4);
