...
parlex::grammar const & get_plange() {
	...
	static parlex::builtins::string_terminal & literal1 = g.add_literal(U" PTR");
	...
	static parlex::builtins::string_terminal & literal81 = g.add_literal(U"atomic");
	static parlex::builtins::string_terminal & literal82 = g.add_literal(U"break");
	static parlex::builtins::string_terminal & literal83 = g.add_literal(U"casts");
	static parlex::builtins::string_terminal & literal84 = g.add_literal(U"catch");
	static parlex::builtins::string_terminal & literal85 = g.add_literal(U"continue");
	static parlex::builtins::string_terminal & literal86 = g.add_literal(U"do");
	static parlex::builtins::string_terminal & literal87 = g.add_literal(U"elif");
	static parlex::builtins::string_terminal & literal88 = g.add_literal(U"else");
	static parlex::builtins::string_terminal & literal89 = g.add_literal(U"extern");
	static parlex::builtins::string_terminal & literal90 = g.add_literal(U"false");
	static parlex::builtins::string_terminal & literal91 = g.add_literal(U"finally");
	static parlex::builtins::string_terminal & literal92 = g.add_literal(U"for");
	static parlex::builtins::string_terminal & literal93 = g.add_literal(U"free");
	static parlex::builtins::string_terminal & literal94 = g.add_literal(U"get");
	static parlex::builtins::string_terminal & literal95 = g.add_literal(U"has");
	static parlex::builtins::string_terminal & literal96 = g.add_literal(U"if");
	static parlex::builtins::string_terminal & literal97 = g.add_literal(U"imperative");
	static parlex::builtins::string_terminal & literal98 = g.add_literal(U"implementing");
	static parlex::builtins::string_terminal & literal99 = g.add_literal(U"import");
	static parlex::builtins::string_terminal & literal100 = g.add_literal(U"in");
	static parlex::builtins::string_terminal & literal101 = g.add_literal(U"inheriting");
	static parlex::builtins::string_terminal & literal102 = g.add_literal(U"internal");
	static parlex::builtins::string_terminal & literal103 = g.add_literal(U"is");
	static parlex::builtins::string_terminal & literal104 = g.add_literal(U"no_throw");
	static parlex::builtins::string_terminal & literal105 = g.add_literal(U"null");
	static parlex::builtins::string_terminal & literal106 = g.add_literal(U"opaque");
	static parlex::builtins::string_terminal & literal107 = g.add_literal(U"or");
	static parlex::builtins::string_terminal & literal108 = g.add_literal(U"private");
	static parlex::builtins::string_terminal & literal109 = g.add_literal(U"protected");
	static parlex::builtins::string_terminal & literal110 = g.add_literal(U"protected internal");
	static parlex::builtins::string_terminal & literal111 = g.add_literal(U"psubs");
	static parlex::builtins::string_terminal & literal112 = g.add_literal(U"psups");
	static parlex::builtins::string_terminal & literal113 = g.add_literal(U"public");
	static parlex::builtins::string_terminal & literal114 = g.add_literal(U"pure");
	static parlex::builtins::string_terminal & literal115 = g.add_literal(U"return");
	static parlex::builtins::string_terminal & literal116 = g.add_literal(U"set");
	static parlex::builtins::string_terminal & literal117 = g.add_literal(U"stable");
	static parlex::builtins::string_terminal & literal118 = g.add_literal(U"static");
	static parlex::builtins::string_terminal & literal119 = g.add_literal(U"subs");
	static parlex::builtins::string_terminal & literal120 = g.add_literal(U"sups");
	static parlex::builtins::string_terminal & literal121 = g.add_literal(U"this");
	static parlex::builtins::string_terminal & literal122 = g.add_literal(U"this_type");
	static parlex::builtins::string_terminal & literal123 = g.add_literal(U"throw");
	static parlex::builtins::string_terminal & literal124 = g.add_literal(U"true");
	static parlex::builtins::string_terminal & literal125 = g.add_literal(U"try");
	static parlex::builtins::string_terminal & literal126 = g.add_literal(U"type");
	static parlex::builtins::string_terminal & literal127 = g.add_literal(U"unstable");
	static parlex::builtins::string_terminal & literal128 = g.add_literal(U"until");
	static parlex::builtins::string_terminal & literal129 = g.add_literal(U"volatile");
	static parlex::builtins::string_terminal & literal130 = g.add_literal(U"while");
	static parlex::builtins::string_terminal & literal131 = g.add_literal(U"xor");
	...
	static parlex::builtins::string_terminal & literal138 = g.add_literal(U"|_");
	...
	static parlex::builtins::string_terminal & literal148 = g.add_literal(U"Δ");
	static parlex::builtins::string_terminal & literal149 = g.add_literal(U"ᶜ");
	static parlex::builtins::string_terminal & literal150 = g.add_literal(U"←");
	...
	static parlex::state_machine & ASSIGNMENT_CHAIN = g.add_production("ASSIGNMENT_CHAIN", 0, 1, parlex::associativity::none);
	...
	static parlex::state_machine & EMBEDDED_NEWLINE_STRING = g.add_production("EMBEDDED_NEWLINE_STRING", 0, 1, parlex::associativity::none);
	static parlex::state_machine & EMBEDDED_NEWLINE_STRING_INTERIOR = g.add_production("EMBEDDED_NEWLINE_STRING_INTERIOR", 0, 1, parlex::associativity::none);
	static parlex::state_machine & EMBEDDED_STRING = g.add_production("EMBEDDED_STRING", 0, 1, parlex::associativity::none);
	static parlex::state_machine & EMBEDDED_STRING_INTERIOR = g.add_production("EMBEDDED_STRING_INTERIOR", 0, 1, parlex::associativity::none);
	...
	static parlex::state_machine & EQUALITY_CHAIN_LOOP = g.add_production("EQUALITY_CHAIN_LOOP", 0, 2, parlex::associativity::none);
	...
	static parlex::state_machine & GREATER_CHAIN_LOOP = g.add_production("GREATER_CHAIN_LOOP", 0, 2, parlex::associativity::none);
	...
	static parlex::state_machine & IDENTIFIER = g.add_production("IDENTIFIER", 0, 1, &parlex::builtins::longest, parlex::associativity::none);
	...
	static parlex::state_machine & LESSER_CHAIN = g.add_production("LESSER_CHAIN", 0, 1, &parlex::builtins::longest, parlex::associativity::none);
	static parlex::state_machine & LESSER_CHAIN_LOOP = g.add_production("LESSER_CHAIN_LOOP", 0, 2, parlex::associativity::none);
	...
	static parlex::state_machine & MEMBER_OFFSET = g.add_production("MEMBER_OFFSET", 0, 1, parlex::associativity::none);
	...
	static parlex::state_machine & STRING = g.add_production("STRING", 0, 1, parlex::associativity::none);
	static parlex::state_machine & SUBSET_CHAIN = g.add_production("SUBSET_CHAIN", 0, 1, &parlex::builtins::longest, parlex::associativity::none);
	static parlex::state_machine & SUBSET_CHAIN_LOOP = g.add_production("SUBSET_CHAIN_LOOP", 0, 2, parlex::associativity::none);
	static parlex::state_machine & SUBTRACTION = g.add_production("SUBTRACTION", 0, 1, parlex::associativity::left);
	static parlex::state_machine & SUPERSET_CHAIN = g.add_production("SUPERSET_CHAIN", 0, 1, &parlex::builtins::longest, parlex::associativity::none);
	static parlex::state_machine & SUPERSET_CHAIN_LOOP = g.add_production("SUPERSET_CHAIN_LOOP", 0, 2, parlex::associativity::none);
	...
	static parlex::state_machine & TYPE_CONSTRAINT = g.add_production("TYPE_CONSTRAINT", 0, 1, parlex::associativity::none);
	static parlex::state_machine & TYPE_CONSTRAINT_CHAIN = g.add_production("TYPE_CONSTRAINT_CHAIN", 0, 2, parlex::associativity::none);
	static parlex::state_machine & TYPE_CONSTRAINT_HEAD = g.add_production("TYPE_CONSTRAINT_HEAD", 0, 1, parlex::associativity::none);
	...
	static parlex::state_machine & TYPE_SCOPE_ASSIGNMENT_CHAIN = g.add_production("TYPE_SCOPE_ASSIGNMENT_CHAIN", 0, 1, parlex::associativity::none);
	static parlex::state_machine & TYPE_SCOPE_DECLARATION = g.add_production("TYPE_SCOPE_DECLARATION", 0, 2, parlex::associativity::none);
	static parlex::state_machine & TYPE_SCOPE_TYPE_CONSTRAINT = g.add_production("TYPE_SCOPE_TYPE_CONSTRAINT", 0, 1, parlex::associativity::none);
	static parlex::state_machine & TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN = g.add_production("TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN", 0, 2, parlex::associativity::none);
	...
	static parlex::state_machine & WS = g.add_production("WS", 0, 1, &parlex::builtins::longest, parlex::associativity::none);
	static parlex::state_machine & XML_DOC_STRING = g.add_production("XML_DOC_STRING", 0, 1, parlex::associativity::none);
	static parlex::state_machine & XML_DOC_STRING_INTERIOR = g.add_production("XML_DOC_STRING_INTERIOR", 0, 1, parlex::associativity::none);
	...
	oneShot.go([&](){
		...
		AND.add_transition(1, literal166, 2);
		...
		ASM_FUNCTION.add_transition(0, literal10, 3);
		ASM_FUNCTION.add_transition(0, literal80, 2);
		ASM_FUNCTION.add_transition(1, literal80, 2);
		ASM_FUNCTION.add_transition(2, IC, 2);
		ASM_FUNCTION.add_transition(2, literal132, 4);
		ASM_FUNCTION.add_transition(3, IC, 3);
		ASM_FUNCTION.add_transition(3, PARAMETER, 5);
		ASM_FUNCTION.add_transition(3, literal12, 6);
		ASM_FUNCTION.add_transition(4, ASM_SCOPE, 7);
		ASM_FUNCTION.add_transition(5, IC, 5);
		ASM_FUNCTION.add_transition(5, literal12, 6);
		ASM_FUNCTION.add_transition(5, literal19, 8);
		ASM_FUNCTION.add_transition(6, FUNCTION_MODIFIER, 1);
		ASM_FUNCTION.add_transition(6, IC, 6);
		ASM_FUNCTION.add_transition(6, literal80, 2);
		ASM_FUNCTION.add_transition(7, literal141, 9);
		ASM_FUNCTION.add_transition(8, IC, 8);
		ASM_FUNCTION.add_transition(8, PARAMETER, 5);

		ASM_IDENTIFIER.add_transition(0, IDENTIFIER, 2);
		ASM_IDENTIFIER.add_transition(0, literal6, 1);
		...
		ASM_PTR_ARITHMETIC_ATT.add_transition(0, ASM_IDENTIFIER, 2);
		ASM_PTR_ARITHMETIC_ATT.add_transition(0, NON_FRACTIONAL, 1);
		ASM_PTR_ARITHMETIC_ATT.add_transition(1, ASM_PTR_ARITHMETIC_ATT_REG, 4);
		ASM_PTR_ARITHMETIC_ATT.add_transition(2, literal44, 3);
		...
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(0, literal10, 1);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(1, ASM_IDENTIFIER, 2);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(1, literal12, 7);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(1, literal19, 3);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(2, literal12, 7);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(2, literal19, 3);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(3, ASM_IDENTIFIER, 4);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(4, literal12, 7);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(4, literal19, 5);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(5, NON_NEG_NON_FRACTIONAL, 6);
		ASM_PTR_ARITHMETIC_ATT_REG.add_transition(6, literal12, 7);

		ASM_PTR_ARITHMETIC_INTEL.add_transition(0, literal60, 2);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(0, literal61, 2);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(0, literal62, 2);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(0, literal63, 2);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(0, literal64, 1);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(1, ASM_IDENTIFIER, 3);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(10, literal16, 5);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(10, literal21, 6);
		...
		ASM_PTR_ARITHMETIC_INTEL.add_transition(12, literal16, 6);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(12, literal21, 6);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(12, literal67, 13);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(2, literal1, 4);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(3, literal16, 5);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(3, literal21, 6);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(3, literal44, 7);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(3, literal67, 13);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(4, literal64, 1);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(5, ASM_IDENTIFIER, 8);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(5, NON_NEG_INTEGER, 9);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(6, NON_NEG_INTEGER, 9);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(7, ASM_IDENTIFIER, 10);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(8, literal13, 11);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(8, literal16, 6);
		ASM_PTR_ARITHMETIC_INTEL.add_transition(8, literal21, 6);
		...
		ASM_STATEMENT.add_transition(4, literal19, 5);
		...
		ASM_STATEMENT.add_transition(5, literal19, 5);

		ASSIGNMENT_CHAIN.add_transition(0, IDENTIFIER, 2);
		ASSIGNMENT_CHAIN.add_transition(0, XML_DOC_STRING, 1);
		ASSIGNMENT_CHAIN.add_transition(1, IC, 1);
		ASSIGNMENT_CHAIN.add_transition(1, IDENTIFIER, 2);
		ASSIGNMENT_CHAIN.add_transition(2, IC, 2);
		ASSIGNMENT_CHAIN.add_transition(2, literal150, 3);
		ASSIGNMENT_CHAIN.add_transition(2, literal48, 3);
		ASSIGNMENT_CHAIN.add_transition(3, ASSIGNMENT_CHAIN, 4);
		ASSIGNMENT_CHAIN.add_transition(3, EXPRESSION, 4);
		ASSIGNMENT_CHAIN.add_transition(3, IC, 3);

		BIJECTION.add_transition(0, EXPRESSION, 1);
		BIJECTION.add_transition(1, IC, 1);
		BIJECTION.add_transition(1, literal154, 2);
		...
		BIT_AND.add_transition(1, literal8, 2);
		BIT_AND.add_transition(2, EXPRESSION, 3);
		BIT_AND.add_transition(2, IC, 2);

		BIT_NOT.add_transition(0, literal143, 1);
		...
		BIT_OR.add_transition(1, literal139, 2);
		...
		BOOL.add_transition(0, literal124, 1);
		BOOL.add_transition(0, literal90, 1);

		CARDINALITY.add_transition(0, literal5, 1);
		...
		CASTS.add_transition(1, literal83, 2);
		CASTS.add_transition(2, EXPRESSION, 3);
		CASTS.add_transition(2, IC, 2);

		CEILING.add_transition(0, literal135, 1);
		CEILING.add_transition(0, literal180, 2);
		...
		CEILING.add_transition(3, literal9, 5);
		CEILING.add_transition(4, IC, 4);
		CEILING.add_transition(4, literal181, 5);
		...
		COMPLEMENT.add_transition(1, literal149, 2);

		COMPOSITION.add_transition(0, EXPRESSION, 1);
		COMPOSITION.add_transition(1, IC, 1);
		COMPOSITION.add_transition(1, literal164, 2);
		...
		COMPOUND.add_transition(1, literal134, 2);
		...
		DEFINITION.add_transition(1, IDENTIFIER, 2);
		DEFINITION.add_transition(2, IC, 2);
		DEFINITION.add_transition(2, literal45, 3);
		DEFINITION.add_transition(3, EXPRESSION, 4);
		DEFINITION.add_transition(3, IC, 3);

		DELTA.add_transition(0, literal148, 1);
		...
		EMBEDDED_COMMENT.add_transition(2, literal14, 3);

		EMBEDDED_COMMENT_INTERIOR.add_transition(0, PAYLOAD, 3);
		EMBEDDED_COMMENT_INTERIOR.add_transition(0, literal13, 1);
		EMBEDDED_COMMENT_INTERIOR.add_transition(1, EMBEDDED_COMMENT_INTERIOR, 2);
		EMBEDDED_COMMENT_INTERIOR.add_transition(2, literal13, 3);

		EMBEDDED_NEWLINE_STRING.add_transition(0, literal4, 1);
		EMBEDDED_NEWLINE_STRING.add_transition(1, EMBEDDED_NEWLINE_STRING_INTERIOR, 2);
		EMBEDDED_NEWLINE_STRING.add_transition(2, literal4, 3);

		EMBEDDED_NEWLINE_STRING_INTERIOR.add_transition(0, literal0, 1);
		EMBEDDED_NEWLINE_STRING_INTERIOR.add_transition(0, literal3, 2);
		EMBEDDED_NEWLINE_STRING_INTERIOR.add_transition(1, PAYLOAD, 3);
		EMBEDDED_NEWLINE_STRING_INTERIOR.add_transition(2, EMBEDDED_NEWLINE_STRING_INTERIOR, 4);
		EMBEDDED_NEWLINE_STRING_INTERIOR.add_transition(3, literal0, 5);
		EMBEDDED_NEWLINE_STRING_INTERIOR.add_transition(4, literal3, 5);

		EMBEDDED_STRING.add_transition(0, literal4, 1);
		EMBEDDED_STRING.add_transition(1, EMBEDDED_STRING_INTERIOR, 2);
		EMBEDDED_STRING.add_transition(2, literal4, 3);

		EMBEDDED_STRING_INTERIOR.add_transition(0, PAYLOAD, 3);
		EMBEDDED_STRING_INTERIOR.add_transition(0, literal3, 1);
		EMBEDDED_STRING_INTERIOR.add_transition(1, EMBEDDED_STRING_INTERIOR, 2);
		EMBEDDED_STRING_INTERIOR.add_transition(2, literal3, 3);
		...
		EQUALITY_CHAIN.add_transition(1, EQUALITY_CHAIN_LOOP, 2);
		EQUALITY_CHAIN.add_transition(1, IC, 1);

		EQUALITY_CHAIN_LOOP.add_transition(0, literal52, 1);
		EQUALITY_CHAIN_LOOP.add_transition(1, EXPRESSION, 2);
		EQUALITY_CHAIN_LOOP.add_transition(1, IC, 1);
		EQUALITY_CHAIN_LOOP.add_transition(2, EQUALITY_CHAIN_LOOP, 3);
		EQUALITY_CHAIN_LOOP.add_transition(2, IC, 2);

		EXISTS.add_transition(0, literal158, 1);
		EXISTS.add_transition(1, EXPRESSION, 2);
		EXISTS.add_transition(1, IC, 1);

		EXISTS_ONE.add_transition(0, literal159, 1);
		...
		EXPRESSION.add_transition(0, STRING, 1);
		...
		EXPRESSION.add_transition(0, literal105, 1);
		EXPRESSION.add_transition(0, literal121, 1);
		...
		FLOOR.add_transition(0, literal138, 2);
		FLOOR.add_transition(0, literal182, 1);
		...
		FLOOR.add_transition(3, literal183, 5);
		FLOOR.add_transition(4, IC, 4);
		FLOOR.add_transition(4, literal75, 5);

		FOR.add_transition(0, literal92, 1);
		FOR.add_transition(1, IC, 1);
		FOR.add_transition(1, literal10, 2);
		...
		FOR.add_transition(5, ASSIGNMENT_CHAIN, 7);
		FOR.add_transition(5, IC, 5);
		FOR.add_transition(5, literal12, 6);
		FOR.add_transition(6, EXPRESSION, 9);
		FOR.add_transition(6, IC, 6);
		FOR.add_transition(7, IC, 7);
		FOR.add_transition(7, literal12, 6);
		FOR.add_transition(7, literal19, 8);
		FOR.add_transition(8, ASSIGNMENT_CHAIN, 7);
		FOR.add_transition(8, IC, 8);

		FOR_COLLECTION.add_transition(0, literal92, 1);
		FOR_COLLECTION.add_transition(1, IC, 1);
		FOR_COLLECTION.add_transition(1, literal10, 2);
		...
		FOR_COLLECTION.add_transition(4, literal100, 5);
		FOR_COLLECTION.add_transition(4, literal160, 5);
		FOR_COLLECTION.add_transition(5, EXPRESSION, 6);
		FOR_COLLECTION.add_transition(5, IC, 5);
		FOR_COLLECTION.add_transition(6, IC, 6);
		FOR_COLLECTION.add_transition(6, literal12, 7);
		FOR_COLLECTION.add_transition(7, EXPRESSION, 8);
		FOR_COLLECTION.add_transition(7, IC, 7);

		FREE.add_transition(0, literal93, 1);
		FREE.add_transition(1, EXPRESSION, 2);
		FREE.add_transition(1, IC, 1);

		FUNCTION.add_transition(0, FUNCTION_MODIFIER, 1);
		FUNCTION.add_transition(0, literal10, 3);
		FUNCTION.add_transition(0, literal132, 2);
		FUNCTION.add_transition(1, literal132, 2);
		FUNCTION.add_transition(2, STATEMENT_SCOPE, 4);
		FUNCTION.add_transition(3, IC, 3);
		FUNCTION.add_transition(3, PARAMETER, 5);
		FUNCTION.add_transition(3, literal12, 6);
		FUNCTION.add_transition(4, literal141, 8);
		FUNCTION.add_transition(5, IC, 5);
		FUNCTION.add_transition(5, literal12, 6);
		FUNCTION.add_transition(5, literal19, 7);
		FUNCTION.add_transition(6, FUNCTION_MODIFIER, 1);
		FUNCTION.add_transition(6, IC, 6);
		FUNCTION.add_transition(6, literal132, 2);
		...
		FUNCTION_MODIFIER_ATOMIC.add_transition(0, literal81, 2);
		...
		FUNCTION_MODIFIER_MODEL.add_transition(0, literal106, 1);
		FUNCTION_MODIFIER_MODEL.add_transition(0, literal114, 1);
		FUNCTION_MODIFIER_MODEL.add_transition(0, literal97, 1);

		FUNCTION_MODIFIER_NO_THROW.add_transition(0, literal104, 2);
		...
		FUNCTION_MODIFIER_STABILITY.add_transition(0, literal117, 2);
		FUNCTION_MODIFIER_STABILITY.add_transition(0, literal127, 2);
		...
		GETTER.add_transition(0, literal94, 1);
		...
		GREATER_CHAIN.add_transition(1, GREATER_CHAIN_LOOP, 2);
		GREATER_CHAIN.add_transition(1, IC, 1);

		GREATER_CHAIN_LOOP.add_transition(0, literal172, 1);
		GREATER_CHAIN_LOOP.add_transition(0, literal52, 1);
		GREATER_CHAIN_LOOP.add_transition(0, literal54, 1);
		GREATER_CHAIN_LOOP.add_transition(0, literal55, 1);
		GREATER_CHAIN_LOOP.add_transition(1, EXPRESSION, 2);
		GREATER_CHAIN_LOOP.add_transition(1, IC, 1);
		GREATER_CHAIN_LOOP.add_transition(2, GREATER_CHAIN_LOOP, 3);
		GREATER_CHAIN_LOOP.add_transition(2, IC, 2);

		HAS.add_transition(0, EXPRESSION, 1);
		HAS.add_transition(1, IC, 1);
		HAS.add_transition(1, literal162, 2);
		HAS.add_transition(1, literal95, 2);
		...
		IF.add_transition(0, literal96, 1);
		...
		IF.add_transition(4, literal87, 1);
		IF.add_transition(4, literal88, 3);

		IFF.add_transition(0, EXPRESSION, 1);
		IFF.add_transition(1, IC, 1);
		IFF.add_transition(1, literal156, 2);
		...
		IMPLICATION.add_transition(1, literal155, 2);
		...
		INEQUALITY.add_transition(1, literal170, 2);
		...
		INTERSECTION.add_transition(1, literal168, 2);
		...
		IS.add_transition(1, literal103, 2);
		...
		KLEENE_STAR.add_transition(1, literal13, 2);

		LESSER_CHAIN.add_transition(0, EXPRESSION, 1);
		LESSER_CHAIN.add_transition(1, IC, 1);
		LESSER_CHAIN.add_transition(1, LESSER_CHAIN_LOOP, 2);

		LESSER_CHAIN_LOOP.add_transition(0, literal171, 1);
		LESSER_CHAIN_LOOP.add_transition(0, literal47, 1);
		LESSER_CHAIN_LOOP.add_transition(0, literal52, 1);
		LESSER_CHAIN_LOOP.add_transition(0, literal53, 1);
		LESSER_CHAIN_LOOP.add_transition(1, EXPRESSION, 2);
		LESSER_CHAIN_LOOP.add_transition(1, IC, 1);
		LESSER_CHAIN_LOOP.add_transition(2, IC, 2);
		LESSER_CHAIN_LOOP.add_transition(2, LESSER_CHAIN_LOOP, 3);

		LIST.add_transition(0, literal65, 1);
		LIST.add_transition(1, EXPRESSION, 2);
		LIST.add_transition(1, IC, 1);
		LIST.add_transition(1, literal137, 4);
		LIST.add_transition(2, IC, 2);
		LIST.add_transition(2, literal137, 4);
		LIST.add_transition(2, literal20, 3);
		LIST.add_transition(3, EXPRESSION, 2);
		LIST.add_transition(3, IC, 3);

		LOOP.add_transition(0, literal128, 1);
		...
		MAP.add_transition(4, literal141, 6);
		...
		MAPS_TO.add_transition(1, literal152, 2);
		...
		MEMBER_OFFSET.add_transition(0, literal59, 1);
		MEMBER_OFFSET.add_transition(1, IC, 1);
		MEMBER_OFFSET.add_transition(1, WHOLE_NUMBER, 2);

		MODULATION.add_transition(0, EXPRESSION, 1);
		MODULATION.add_transition(1, IC, 1);
		MODULATION.add_transition(1, literal6, 2);
		...
		MULTIPLICATION.add_transition(1, literal13, 2);
		...
		NAND.add_transition(1, literal151, 2);
		NAND.add_transition(2, EXPRESSION, 3);
		NAND.add_transition(2, IC, 2);

		NEAREST_INTEGER.add_transition(0, literal138, 2);
		NEAREST_INTEGER.add_transition(0, literal182, 1);
		...
		NEAREST_INTEGER.add_transition(3, literal181, 5);
		NEAREST_INTEGER.add_transition(4, IC, 4);
		NEAREST_INTEGER.add_transition(4, literal9, 5);
		...
		NON_FRACTIONAL.add_transition(0, literal21, 1);
		NON_FRACTIONAL.add_transition(1, NON_NEG_NON_FRACTIONAL, 2);

		NON_NEG_FRACTIONAL.add_transition(0, literal24, 2);
		NON_NEG_FRACTIONAL.add_transition(0, parlex::builtins::decimal_digit, 1);
		NON_NEG_FRACTIONAL.add_transition(1, literal24, 3);
		...
		NON_NEG_INTEGER.add_transition(0, NON_ZERO_DECIMAL_DIGIT, 1);
		NON_NEG_INTEGER.add_transition(0, literal33, 2);
		NON_NEG_INTEGER.add_transition(1, parlex::builtins::decimal_digit, 1);
		...
		NOR.add_transition(1, literal153, 2);
		NOR.add_transition(2, EXPRESSION, 3);
		NOR.add_transition(2, IC, 2);

		NOT.add_transition(0, literal142, 1);
		...
		NOT_HAS.add_transition(1, literal163, 2);
		...
		NOT_IN.add_transition(1, literal161, 2);
		...
		OR.add_transition(1, literal107, 2);
		OR.add_transition(1, literal167, 2);
		...
		POST_DEC.add_transition(1, literal22, 2);
		...
		PREPEND.add_transition(1, literal7, 2);
		...
		PRE_INC.add_transition(0, literal17, 1);
		PRE_INC.add_transition(1, EXPRESSION, 2);
		PRE_INC.add_transition(1, IC, 1);

		PROPERTY.add_transition(0, literal132, 1);
		...
		PROPERTY.add_transition(2, literal141, 5);
		PROPERTY.add_transition(2, literal19, 4);
		PROPERTY.add_transition(3, IC, 3);
		PROPERTY.add_transition(3, literal141, 5);
		PROPERTY.add_transition(4, IC, 4);
		PROPERTY.add_transition(4, SETTER, 3);

		RADICAL.add_transition(0, literal165, 1);
		RADICAL.add_transition(1, EXPRESSION, 2);
		RADICAL.add_transition(1, IC, 1);

		RANGE.add_transition(0, literal10, 1);
		...
		RANGE.add_transition(5, literal12, 7);
		RANGE.add_transition(6, IC, 6);
		RANGE.add_transition(6, literal12, 7);
		RANGE.add_transition(6, literal67, 7);
		...
		SET_COMPREHENSION.add_transition(0, literal132, 1);
		...
		SET_COMPREHENSION.add_transition(2, literal134, 3);
		...
		SET_COMPREHENSION.add_transition(4, literal141, 5);
		...
		STATEMENT.add_transition(0, ASSIGNMENT_CHAIN, 1);
		...
		STATEMENT.add_transition(0, literal82, 1);
		STATEMENT.add_transition(0, literal85, 1);
		...
		STRING.add_transition(0, parlex::builtins::c_string, 1);

		SUBSET_CHAIN.add_transition(0, EXPRESSION, 1);
		SUBSET_CHAIN.add_transition(1, IC, 1);
		SUBSET_CHAIN.add_transition(1, SUBSET_CHAIN_LOOP, 2);

		SUBSET_CHAIN_LOOP.add_transition(0, literal111, 1);
		SUBSET_CHAIN_LOOP.add_transition(0, literal119, 1);
		SUBSET_CHAIN_LOOP.add_transition(0, literal173, 1);
		SUBSET_CHAIN_LOOP.add_transition(0, literal175, 1);
		SUBSET_CHAIN_LOOP.add_transition(0, literal52, 1);
		SUBSET_CHAIN_LOOP.add_transition(1, EXPRESSION, 2);
		SUBSET_CHAIN_LOOP.add_transition(1, IC, 1);
		SUBSET_CHAIN_LOOP.add_transition(2, IC, 2);
		SUBSET_CHAIN_LOOP.add_transition(2, SUBSET_CHAIN_LOOP, 3);
		...
		SUPERSET_CHAIN.add_transition(1, SUPERSET_CHAIN_LOOP, 2);

		SUPERSET_CHAIN_LOOP.add_transition(0, literal112, 1);
		SUPERSET_CHAIN_LOOP.add_transition(0, literal120, 1);
		SUPERSET_CHAIN_LOOP.add_transition(0, literal174, 1);
		SUPERSET_CHAIN_LOOP.add_transition(0, literal176, 1);
		SUPERSET_CHAIN_LOOP.add_transition(0, literal52, 1);
		SUPERSET_CHAIN_LOOP.add_transition(1, EXPRESSION, 2);
		SUPERSET_CHAIN_LOOP.add_transition(1, IC, 1);
		SUPERSET_CHAIN_LOOP.add_transition(2, IC, 2);
		SUPERSET_CHAIN_LOOP.add_transition(2, SUPERSET_CHAIN_LOOP, 3);

		SYMMETRIC_DIFFERENCE.add_transition(0, EXPRESSION, 1);
		SYMMETRIC_DIFFERENCE.add_transition(1, IC, 1);
		SYMMETRIC_DIFFERENCE.add_transition(1, literal178, 2);
		SYMMETRIC_DIFFERENCE.add_transition(2, EXPRESSION, 3);
		SYMMETRIC_DIFFERENCE.add_transition(2, IC, 2);

		THROW.add_transition(0, literal123, 1);
		THROW.add_transition(1, EXPRESSION, 2);
		THROW.add_transition(1, IC, 1);

		TRY.add_transition(0, literal125, 1);
		TRY.add_transition(1, EXPRESSION, 2);
		TRY.add_transition(1, IC, 1);
		TRY.add_transition(2, IC, 2);
		TRY.add_transition(2, literal84, 3);
		...
		TRY.add_transition(5, literal84, 3);
		TRY.add_transition(5, literal91, 4);
		TRY.add_transition(6, IC, 6);
		TRY.add_transition(6, literal91, 4);

		TUPLE.add_transition(0, literal11, 1);
		TUPLE.add_transition(1, EXPRESSION, 2);
		TUPLE.add_transition(1, IC, 1);
		TUPLE.add_transition(2, IC, 2);
		TUPLE.add_transition(2, literal136, 3);
		TUPLE.add_transition(2, literal19, 1);

		TYPE.add_transition(0, literal126, 1);
		TYPE.add_transition(1, IC, 1);
		TYPE.add_transition(1, literal101, 3);
		TYPE.add_transition(1, literal132, 2);
		TYPE.add_transition(1, literal98, 4);
		...
		TYPE.add_transition(5, literal141, 8);
		TYPE.add_transition(6, IC, 6);
		TYPE.add_transition(6, literal132, 2);
		TYPE.add_transition(6, literal98, 4);
		TYPE.add_transition(7, IC, 7);
		TYPE.add_transition(7, literal132, 2);

		TYPE_CONSTRAINT.add_transition(0, TYPE_CONSTRAINT_HEAD, 1);
		TYPE_CONSTRAINT.add_transition(1, IC, 1);
		TYPE_CONSTRAINT.add_transition(1, TYPE_CONSTRAINT_CHAIN, 2);

		TYPE_CONSTRAINT_CHAIN.add_transition(0, ASSIGNMENT_CHAIN, 2);
		TYPE_CONSTRAINT_CHAIN.add_transition(0, DECLARATION, 2);
		TYPE_CONSTRAINT_CHAIN.add_transition(0, DEFINITION, 2);
		TYPE_CONSTRAINT_CHAIN.add_transition(1, IC, 1);
		TYPE_CONSTRAINT_CHAIN.add_transition(1, TYPE_CONSTRAINT_CHAIN, 3);
		TYPE_CONSTRAINT_CHAIN.add_transition(2, IC, 2);
		TYPE_CONSTRAINT_CHAIN.add_transition(2, literal19, 1);

		TYPE_CONSTRAINT_HEAD.add_transition(0, IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(0, TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(0, VISIBILITY_MODIFIER, 3);
		TYPE_CONSTRAINT_HEAD.add_transition(0, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(0, VOLATILE_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(0, XML_DOC_STRING, 4);
		TYPE_CONSTRAINT_HEAD.add_transition(0, literal118, 1);
		TYPE_CONSTRAINT_HEAD.add_transition(0, literal89, 2);
		TYPE_CONSTRAINT_HEAD.add_transition(1, IC, 1);
		TYPE_CONSTRAINT_HEAD.add_transition(1, IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(1, TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(1, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(1, VOLATILE_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(1, literal89, 2);
		TYPE_CONSTRAINT_HEAD.add_transition(2, IC, 2);
		TYPE_CONSTRAINT_HEAD.add_transition(2, IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(2, TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(2, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(2, VOLATILE_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(3, IC, 3);
		TYPE_CONSTRAINT_HEAD.add_transition(3, IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(3, TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(3, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(3, VOLATILE_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(3, literal118, 1);
		TYPE_CONSTRAINT_HEAD.add_transition(3, literal89, 2);
		TYPE_CONSTRAINT_HEAD.add_transition(4, IC, 4);
		TYPE_CONSTRAINT_HEAD.add_transition(4, IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(4, TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(4, VISIBILITY_MODIFIER, 3);
		TYPE_CONSTRAINT_HEAD.add_transition(4, VOLATILE_IMPLICIT_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(4, VOLATILE_TYPE_DEREFERENCE, 5);
		TYPE_CONSTRAINT_HEAD.add_transition(4, literal118, 1);
		TYPE_CONSTRAINT_HEAD.add_transition(4, literal89, 2);
		...
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(0, IDENTIFIER, 2);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(0, XML_DOC_STRING, 1);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(1, IC, 1);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(1, IDENTIFIER, 2);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(2, IC, 2);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(2, MEMBER_OFFSET, 4);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(2, literal150, 3);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(2, literal48, 3);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(3, ASSIGNMENT_CHAIN, 5);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(3, EXPRESSION, 5);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(3, IC, 3);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(4, IC, 4);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(4, literal150, 3);
		TYPE_SCOPE_ASSIGNMENT_CHAIN.add_transition(4, literal48, 3);

		TYPE_SCOPE_DECLARATION.add_transition(0, IDENTIFIER, 2);
		TYPE_SCOPE_DECLARATION.add_transition(0, XML_DOC_STRING, 1);
		TYPE_SCOPE_DECLARATION.add_transition(1, IC, 1);
		TYPE_SCOPE_DECLARATION.add_transition(1, IDENTIFIER, 2);
		TYPE_SCOPE_DECLARATION.add_transition(2, IC, 2);
		TYPE_SCOPE_DECLARATION.add_transition(2, MEMBER_OFFSET, 3);

		TYPE_SCOPE_TYPE_CONSTRAINT.add_transition(0, TYPE_CONSTRAINT_HEAD, 1);
		TYPE_SCOPE_TYPE_CONSTRAINT.add_transition(1, IC, 1);
		TYPE_SCOPE_TYPE_CONSTRAINT.add_transition(1, TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN, 2);

		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(0, DEFINITION, 3);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(0, TYPE_SCOPE_ASSIGNMENT_CHAIN, 3);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(0, TYPE_SCOPE_DECLARATION, 3);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(0, XML_DOC_STRING, 1);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(1, DEFINITION, 3);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(1, IC, 1);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(1, TYPE_SCOPE_ASSIGNMENT_CHAIN, 3);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(1, TYPE_SCOPE_DECLARATION, 3);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(2, IC, 2);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(2, TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN, 4);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(3, IC, 3);
		TYPE_SCOPE_TYPE_CONSTRAINT_CHAIN.add_transition(3, literal19, 2);

		TYPE_STATEMENT.add_transition(0, STATEMENT, 2);
		TYPE_STATEMENT.add_transition(0, TYPE_SCOPE_TYPE_CONSTRAINT, 2);
		TYPE_STATEMENT.add_transition(0, VISIBILITY_MODIFIER, 1);
		TYPE_STATEMENT.add_transition(1, IC, 1);
		TYPE_STATEMENT.add_transition(1, literal44, 2);
		...
		UNION.add_transition(1, literal169, 2);
		...
		VOLATILE_TYPE_DEREFERENCE.add_transition(1, literal129, 2);
		...
		XML_DOC_STRING.add_transition(0, literal77, 1);
		XML_DOC_STRING.add_transition(1, XML_DOC_STRING_INTERIOR, 2);
		XML_DOC_STRING.add_transition(2, literal77, 3);

		XML_DOC_STRING_INTERIOR.add_transition(0, PAYLOAD, 3);
		XML_DOC_STRING_INTERIOR.add_transition(0, literal76, 1);
		XML_DOC_STRING_INTERIOR.add_transition(1, XML_DOC_STRING_INTERIOR, 2);
		XML_DOC_STRING_INTERIOR.add_transition(2, literal76, 3);

		XOR.add_transition(0, EXPRESSION, 1);
		XOR.add_transition(1, IC, 1);
		XOR.add_transition(1, literal131, 2);
		XOR.add_transition(1, literal177, 2);
		...
		g.add_precedence(ASSIGNMENT_CHAIN, EXPRESSION);
		...
		g.add_precedence(EMBEDDED_COMMENT, COMMENT);
		g.add_precedence(EMBEDDED_NEWLINE_STRING, EMBEDDED_STRING);
		g.add_precedence(EMBEDDED_NEWLINE_STRING, STRING);
		g.add_precedence(EMBEDDED_STRING, STRING);
		g.add_precedence(EQUALITY_CHAIN, GREATER_CHAIN);
		g.add_precedence(EQUALITY_CHAIN, LESSER_CHAIN);
		g.add_precedence(EQUALITY_CHAIN, SUBSET_CHAIN);
		g.add_precedence(EQUALITY_CHAIN, SUPERSET_CHAIN);
		g.add_precedence(EQUALITY_CHAIN_LOOP, EXPRESSION);
		...
		g.add_precedence(LESSER_CHAIN_LOOP, EXPRESSION);
		...
		g.add_precedence(RADICAL, MULTIPLICATIVE_OP);
		g.add_precedence(RADICAL, SUBTRACTION);
		g.add_precedence(RELATIONAL_OP, BINARY_LOGICAL_OP);
		g.add_precedence(SET, MAGNITUDE);
		g.add_precedence(SUBSET_CHAIN_LOOP, EXPRESSION);
		g.add_precedence(SUPERSET_CHAIN_LOOP, EXPRESSION);
		g.add_precedence(TUPLE, MAGNITUDE);
		g.add_precedence(TYPE_SCOPE_ASSIGNMENT_CHAIN, EXPRESSION);
