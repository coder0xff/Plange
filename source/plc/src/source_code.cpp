...
void payload_postprocess(parlex::details::abstract_syntax_graph & asg) {
...
std::vector<std::set<parlex::details::match>> matches_by_height(parlex::details::abstract_syntax_graph const & asg) {
