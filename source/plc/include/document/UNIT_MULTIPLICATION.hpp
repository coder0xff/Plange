...
struct UNIT_MULTIPLICATION {
	...
	explicit UNIT_MULTIPLICATION
		(int32_t documentPosition, int32_t consumedCharacterCount, erased<DIMENSION> && field_1, parlex::detail::document::text<literal_0x2A_t> && dont_care1, erased<DIMENSION> && field_2)
