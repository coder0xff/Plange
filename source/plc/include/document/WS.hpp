...
struct WS {
	...
	explicit WS
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<parlex::detail::white_space_t> && field_1, std::vector<parlex::detail::document::text<parlex::detail::white_space_t>> && field_2)
