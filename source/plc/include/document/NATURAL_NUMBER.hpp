...
struct NATURAL_NUMBER {
	...
	explicit NATURAL_NUMBER
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<parlex::detail::decimal_digit_t> && field_1, std::vector<parlex::detail::document::text<parlex::detail::decimal_digit_t>> && field_2)
	...
	NATURAL_NUMBER(NATURAL_NUMBER && move) = default;
