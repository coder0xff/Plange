...
struct MAP {
	...
	struct field_1_t {
		struct field_6_t {
			...
			explicit field_6_t
				(std::vector<val<IC>> && field_1, parlex::detail::document::text<literal_0x2C_t> && dont_care1, std::vector<val<IC>> && field_2, val<EXPRESSION> && field_3, std::vector<val<IC>> && field_4, parlex::detail::document::text<literal_0x3A_t> && dont_care5, std::vector<val<IC>> && field_5, val<EXPRESSION> && field_6)
		...
		explicit field_1_t
			(std::vector<val<IC>> && field_1, val<EXPRESSION> && field_2, std::vector<val<IC>> && field_3, parlex::detail::document::text<literal_0x3A_t> && dont_care3, std::vector<val<IC>> && field_4, val<EXPRESSION> && field_5, std::vector<field_6_t> && field_6)
	...
	explicit MAP
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_0x7B_t> && dont_care0, std::optional<field_1_t> && field_1, std::vector<val<IC>> && field_2, parlex::detail::document::text<literal_0x7D_t> && dont_care3)
