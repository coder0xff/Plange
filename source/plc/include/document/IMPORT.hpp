...
struct IMPORT {
	...
	explicit IMPORT
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_import_t> && dont_care0, std::vector<erased<IC>> && field_1, erased<EXPRESSION> && field_2)
