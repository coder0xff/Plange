...
struct BIT_NOT_ASSIGNMENT {
	...
	parlex::detail::document::text<literal_0x7E0x7E_t> dontCare2;
	...
	explicit BIT_NOT_ASSIGNMENT(
		erased<EXPRESSION> && field_1, std::vector<erased<IC>> && field_2, parlex::detail::document::text<literal_0x7E0x7E_t> && dontCare2, std::variant<
			parlex::detail::document::text<literal_0x3C0x2D_t>,
			parlex::detail::document::text<literal_0xE20x860x90_t>
