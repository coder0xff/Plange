...
#ifndef INCLUDED_SHIFTL_ASSIGNMENT_HPP
#define INCLUDED_SHIFTL_ASSIGNMENT_HPP
...
struct SHIFTL_ASSIGNMENT {
	...
	explicit SHIFTL_ASSIGNMENT
		(int32_t documentPosition, int32_t consumedCharacterCount, erased<EXPRESSION> && field_1, std::vector<erased<IC>> && field_2, parlex::detail::document::text<literal_0x3C0x3C_t> && dont_care2, std::variant<
	parlex::detail::document::text<literal_0x3C0x2D_t>,
	parlex::detail::document::text<literal_0xE20x860x90_t>
> && field_3, std::vector<erased<IC>> && field_4, erased<EXPRESSION> && field_5)
	...
	SHIFTL_ASSIGNMENT(SHIFTL_ASSIGNMENT && move) = default;
...
#endif //INCLUDED_SHIFTL_ASSIGNMENT_HPP
