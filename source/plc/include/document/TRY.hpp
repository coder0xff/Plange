...
struct TRY {
	...
	struct field_06_t {
		...
		explicit field_06_t
			(parlex::detail::document::text<literal_catch_t> && dont_care0, std::vector<erased<IC>> && field_1, erased<EXPRESSION> && field_2)
	...
	struct field_07_t {
		...
		explicit field_07_t
			(std::vector<erased<IC>> && field_1, parlex::detail::document::text<literal_finally_t> && dont_care1, std::vector<erased<IC>> && field_2, erased<EXPRESSION> && field_3)
	...
	explicit TRY
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_try_t> && dont_care0, std::vector<erased<IC>> && field_01, erased<EXPRESSION> && field_02, std::vector<erased<IC>> && field_03, parlex::detail::document::text<literal_catch_t> && dont_care4, std::vector<erased<IC>> && field_04, erased<EXPRESSION> && field_05, std::vector<field_06_t> && field_06, std::optional<field_07_t> && field_07)
