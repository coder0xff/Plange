...
struct VOLATILE_TYPE_DEREFERENCE {
	...
	parlex::details::document::text<literal_0x3E_t> dontCare6;
	


	explicit VOLATILE_TYPE_DEREFERENCE(
		parlex::details::document::text<literal_0x3C_t> && dontCare0, std::vector<erased<IC>> && field_1, parlex::details::document::text<literal_volatile_t> && dontCare2, std::vector<erased<IC>> && field_2, erased<EXPRESSION> && field_3, std::vector<erased<IC>> && field_4, parlex::details::document::text<literal_0x3E_t> && dontCare6) : dontCare0(std::move(dontCare0)), field_1(std::move(field_1)), dontCare2(std::move(dontCare2)), field_2(std::move(field_2)), field_3(std::move(field_3)), field_4(std::move(field_4)), dontCare6(std::move(dontCare6)) {}
