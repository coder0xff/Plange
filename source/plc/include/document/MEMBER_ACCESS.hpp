...
struct MEMBER_ACCESS {
	...
	explicit MEMBER_ACCESS
		(int32_t documentPosition, int32_t consumedCharacterCount, val<EXPRESSION> && field_1, std::vector<val<IC>> && field_2, parlex::detail::document::text<literal_0x2E_t> && dont_care2, std::vector<val<IC>> && field_3, val<IDENTIFIER> && field_4)
