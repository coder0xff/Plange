...
struct SET_COMPREHENSION {
	...
	explicit SET_COMPREHENSION
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_0x7B_t> && dont_care0, std::vector<erased<IC>> && field_01, erased<EXPRESSION> && field_02, std::vector<erased<IC>> && field_03, parlex::detail::document::text<literal_0x7C_t> && dont_care4, std::vector<erased<IC>> && field_04, erased<EXPRESSION> && field_05, std::vector<erased<IC>> && field_06, parlex::detail::document::text<literal_0x7D_t> && dont_care8)
