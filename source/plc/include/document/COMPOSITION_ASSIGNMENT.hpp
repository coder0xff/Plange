...
#ifndef INCLUDED_COMPOSITION_ASSIGNMENT_HPP
#define INCLUDED_COMPOSITION_ASSIGNMENT_HPP
...
struct COMPOSITION_ASSIGNMENT {
	...
	COMPOSITION_ASSIGNMENT(COMPOSITION_ASSIGNMENT && move) = default;
...
#endif //INCLUDED_COMPOSITION_ASSIGNMENT_HPP
