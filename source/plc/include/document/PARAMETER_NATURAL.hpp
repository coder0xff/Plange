...
struct PARAMETER_NATURAL_1_t {
	...
	std::optional<parlex::details::document::text<literal_0x2E0x2E0x2E_t>> field_3;
	


	explicit PARAMETER_NATURAL_1_t(
		std::optional<field_1_t_1_t> && field_1, erased<IDENTIFIER> && field_2, std::optional<parlex::details::document::text<literal_0x2E0x2E0x2E_t>> && field_3) : field_1(std::move(field_1)), field_2(std::move(field_2)), field_3(std::move(field_3)) {}

	PARAMETER_NATURAL_1_t(PARAMETER_NATURAL_1_t const & other) = default;
	PARAMETER_NATURAL_1_t(PARAMETER_NATURAL_1_t && move) = default;

	static PARAMETER_NATURAL_1_t build(parlex::details::behavior::node const * b, parlex::details::document::walk & w);
};
...
struct PARAMETER_NATURAL_2_t {
	...
	parlex::details::document::text<literal_0x3D_t> dontCare4;
	
	std::vector<erased<IC>> field_5;
	
	erased<EXPRESSION> field_6;
	
	std::optional<parlex::details::document::text<literal_0x2E0x2E0x2E_t>> field_7;
	


	explicit PARAMETER_NATURAL_2_t(
		std::optional<field_1_t_1_t> && field_1, erased<IDENTIFIER> && field_2, std::optional<parlex::details::document::text<literal_0x2E0x2E0x2E_t>> && field_3, std::vector<erased<IC>> && field_4, parlex::details::document::text<literal_0x3D_t> && dontCare4, std::vector<erased<IC>> && field_5, erased<EXPRESSION> && field_6, std::optional<parlex::details::document::text<literal_0x2E0x2E0x2E_t>> && field_7) : field_1(std::move(field_1)), field_2(std::move(field_2)), field_3(std::move(field_3)), field_4(std::move(field_4)), dontCare4(std::move(dontCare4)), field_5(std::move(field_5)), field_6(std::move(field_6)), field_7(std::move(field_7)) {}

	PARAMETER_NATURAL_2_t(PARAMETER_NATURAL_2_t const & other) = default;
	PARAMETER_NATURAL_2_t(PARAMETER_NATURAL_2_t && move) = default;

	static PARAMETER_NATURAL_2_t build(parlex::details::behavior::node const * b, parlex::details::document::walk & w);
};
