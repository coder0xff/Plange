...
struct PARAMETER_NATURAL_1_t {
	...
	static PARAMETER_NATURAL_1_t build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
...
struct PARAMETER_NATURAL_2_t {
	...
	static PARAMETER_NATURAL_2_t build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
...
struct PARAMETER_NATURAL: PARAMETER_NATURAL_base {
	static PARAMETER_NATURAL build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
