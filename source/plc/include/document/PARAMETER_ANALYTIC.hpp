...
struct PARAMETER_ANALYTIC {
	...
	struct field_2_t {
		...
		explicit field_2_t
			(std::vector<erased<IC>> && field_1, parlex::detail::document::text<literal_0x3D_t> && dont_care1, std::vector<erased<IC>> && field_2, erased<EXPRESSION> && field_3)
	...
	explicit PARAMETER_ANALYTIC
		(int32_t documentPosition, int32_t consumedCharacterCount, erased<EXPRESSION> && field_1, std::optional<field_2_t> && field_2)
