...
#ifndef INCLUDED_BIT_OR_ASSIGNMENT_HPP
#define INCLUDED_BIT_OR_ASSIGNMENT_HPP
...
struct BIT_OR_ASSIGNMENT {
	...
	explicit BIT_OR_ASSIGNMENT
		(int32_t documentPosition, int32_t consumedCharacterCount, erased<EXPRESSION> && field_1, std::vector<erased<IC>> && field_2, parlex::detail::document::text<literal_0x7C0x7C_t> && dont_care2, std::variant<
	parlex::detail::document::text<literal_0x3C0x2D_t>,
	parlex::detail::document::text<literal_0xE20x860x90_t>
> && field_3, std::vector<erased<IC>> && field_4, erased<EXPRESSION> && field_5)
	...
	BIT_OR_ASSIGNMENT(BIT_OR_ASSIGNMENT && move) = default;
...
#endif //INCLUDED_BIT_OR_ASSIGNMENT_HPP
