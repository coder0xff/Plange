...
struct EMBEDDED_STRING {
	...
	explicit EMBEDDED_STRING
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_0x220x220x22_t> && dont_care0, val<EMBEDDED_STRING_INTERIOR> && field_1, parlex::detail::document::text<literal_0x220x220x22_t> && dont_care2)
