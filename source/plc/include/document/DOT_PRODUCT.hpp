...
struct DOT_PRODUCT {
	struct field_3_t {
		enum type {
			literal_0xE20x8B0x85,
			literal__dot_
		} value;
	
		static field_3_t build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n) {
			static ::std::unordered_map<parlex::details::recognizer const *, type> const table {
				{ &plange_grammar::get().get_literal("literal_0xE20x8B0x85"), literal_0xE20x8B0x85 },
				{ &plange_grammar::get().get_literal("literal__dot_"), literal__dot_ },
			};
	...
	static DOT_PRODUCT build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
