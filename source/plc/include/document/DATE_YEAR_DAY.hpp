...
struct DATE_YEAR_DAY {
	...
	explicit DATE_YEAR_DAY(
		parlex::details::document::built_in_terminal<parlex::details::decimal_digit_t> && field_1, parlex::details::document::built_in_terminal<parlex::details::decimal_digit_t> && field_2, parlex::details::document::built_in_terminal<parlex::details::decimal_digit_t> && field_3, parlex::details::document::built_in_terminal<parlex::details::decimal_digit_t> && field_4, parlex::details::document::built_in_terminal<parlex::details::decimal_digit_t> && field_5, parlex::details::document::built_in_terminal<parlex::details::decimal_digit_t> && field_6, parlex::details::document::built_in_terminal<parlex::details::decimal_digit_t> && field_7) : field_1(std::move(field_1)), field_2(std::move(field_2)), field_3(std::move(field_3)), field_4(std::move(field_4)), field_5(std::move(field_5)), field_6(std::move(field_6)), field_7(std::move(field_7)) {}

	DATE_YEAR_DAY(DATE_YEAR_DAY const & other) = default;
	DATE_YEAR_DAY(DATE_YEAR_DAY && move) = default;

	static DATE_YEAR_DAY build(std::u32string const & document, parlex::details::ast_node const & n);
