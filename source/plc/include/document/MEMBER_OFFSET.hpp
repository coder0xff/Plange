...
struct MEMBER_OFFSET {
	...
	explicit MEMBER_OFFSET(
		parlex::details::document::text<literal_0x40_t> && dontCare0, std::vector<erased<IC>> && field_1, erased<WHOLE_NUMBER> && field_2) : dontCare0(std::move(dontCare0)), field_1(std::move(field_1)), field_2(std::move(field_2)) {}
