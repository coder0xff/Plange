...
struct PRE_INC {
	...
	explicit PRE_INC
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_0x2B0x2B_t> && dont_care0, std::vector<erased<IC>> && field_1, erased<EXPRESSION> && field_2)
