...
struct PRE_INC {
	...
	explicit PRE_INC
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_0x2B0x2B_t> && dont_care0, std::vector<val<IC>> && field_1, val<EXPRESSION> && field_2)
