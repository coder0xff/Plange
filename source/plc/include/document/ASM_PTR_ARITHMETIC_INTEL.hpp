...
struct ASM_PTR_ARITHMETIC_INTEL {
	struct field_1_t_1_t {
		...
		parlex::details::document::text<literal_0x20PTR_t> dontCare1;
		...
		explicit field_1_t_1_t(
			std::variant<
				...
				parlex::details::document::text<literal_DWORD_t>,
				parlex::details::document::text<literal_QWORD_t>
			> && field_1, parlex::details::document::text<literal_0x20PTR_t> && dontCare1) : field_1(std::move(field_1)), dontCare1(std::move(dontCare1)) {}
	...
	struct field_2_t_1_t {
		...
		parlex::details::document::text<literal_0x3A_t> dontCare1;
		
	
	
		explicit field_2_t_1_t(
			erased<ASM_IDENTIFIER> && field_1, parlex::details::document::text<literal_0x3A_t> && dontCare1) : field_1(std::move(field_1)), dontCare1(std::move(dontCare1)) {}
	...
	struct field_4_t_1_t {
		struct field_2_t_1_t {
			...
			explicit field_2_t_1_t(
				parlex::details::document::text<literal_0x2A_t> && dontCare0, erased<NON_NEG_NON_FRACTIONAL> && field_1) : dontCare0(std::move(dontCare0)), field_1(std::move(field_1)) {}
		...
		parlex::details::document::text<literal_0x2B_t> dontCare0;
		...
		explicit field_4_t_1_t(
			parlex::details::document::text<literal_0x2B_t> && dontCare0, erased<ASM_IDENTIFIER> && field_1, std::optional<field_2_t_1_t> && field_2) : dontCare0(std::move(dontCare0)), field_1(std::move(field_1)), field_2(std::move(field_2)) {}
	...
	parlex::details::document::text<literal_0x5D_t> dontCare6;
	


	explicit ASM_PTR_ARITHMETIC_INTEL(
		std::optional<field_1_t_1_t> && field_1, parlex::details::document::text<literal_0x5B_t> && dontCare1, std::optional<field_2_t_1_t> && field_2, erased<ASM_IDENTIFIER> && field_3, std::optional<field_4_t_1_t> && field_4, std::optional<field_5_t_1_t> && field_5, parlex::details::document::text<literal_0x5D_t> && dontCare6) : field_1(std::move(field_1)), dontCare1(std::move(dontCare1)), field_2(std::move(field_2)), field_3(std::move(field_3)), field_4(std::move(field_4)), field_5(std::move(field_5)), dontCare6(std::move(dontCare6)) {}
	...
	static ASM_PTR_ARITHMETIC_INTEL build(parlex::details::ast_node const & n);
