...
struct ASM_PTR_ARITHMETIC_ATT_1_t {
	...
	explicit ASM_PTR_ARITHMETIC_ATT_1_t(
		erased<ASM_IDENTIFIER> && field_1, erased<NON_FRACTIONAL> && field_2) : field_1(std::move(field_1)), field_2(std::move(field_2)) {}
	...
	static ASM_PTR_ARITHMETIC_ATT_1_t build(std::u32string const & document, parlex::details::behavior::node const & b, parlex::details::document::walk & w);
...
struct ASM_PTR_ARITHMETIC_ATT_2_t {
	...
	explicit ASM_PTR_ARITHMETIC_ATT_2_t(
		erased<ASM_IDENTIFIER> && field_1, erased<NON_FRACTIONAL> && field_2, erased<ASM_PTR_ARITHMETIC_ATT_REG> && field_3) : field_1(std::move(field_1)), field_2(std::move(field_2)), field_3(std::move(field_3)) {}
	...
	static ASM_PTR_ARITHMETIC_ATT_2_t build(std::u32string const & document, parlex::details::behavior::node const & b, parlex::details::document::walk & w);
...
struct ASM_PTR_ARITHMETIC_ATT_3_t {
	...
	static ASM_PTR_ARITHMETIC_ATT_3_t build(std::u32string const & document, parlex::details::behavior::node const & b, parlex::details::document::walk & w);
...
struct ASM_PTR_ARITHMETIC_ATT: ASM_PTR_ARITHMETIC_ATT_base {
	static ASM_PTR_ARITHMETIC_ATT build(std::u32string const & document, parlex::details::ast_node const & n);
