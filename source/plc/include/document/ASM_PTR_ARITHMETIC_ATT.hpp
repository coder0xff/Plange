...
struct ASM_PTR_ARITHMETIC_ATT_1_t {
	...
	static ASM_PTR_ARITHMETIC_ATT_1_t build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
...
struct ASM_PTR_ARITHMETIC_ATT_2_t {
	...
	static ASM_PTR_ARITHMETIC_ATT_2_t build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
...
struct ASM_PTR_ARITHMETIC_ATT_3_t {
	...
	static ASM_PTR_ARITHMETIC_ATT_3_t build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
...
struct ASM_PTR_ARITHMETIC_ATT: ASM_PTR_ARITHMETIC_ATT_base {
	static ASM_PTR_ARITHMETIC_ATT build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
