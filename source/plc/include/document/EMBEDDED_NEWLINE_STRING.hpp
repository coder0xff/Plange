...
struct EMBEDDED_NEWLINE_STRING {
	...
	explicit EMBEDDED_NEWLINE_STRING
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_0x220x220x22_t> && dont_care0, val<EMBEDDED_NEWLINE_STRING_INTERIOR> && field_1, parlex::detail::document::text<literal_0x220x220x22_t> && dont_care2)
