...
struct ALLOCATION {
	...
	explicit ALLOCATION
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_alloc_t> && dont_care0, std::vector<erased<IC>> && field_1, erased<PARENTHETICAL_INVOCATION> && field_2)
