...
struct TYPE_CONSTRAINT {
	...
	explicit TYPE_CONSTRAINT
		(int32_t documentPosition, int32_t consumedCharacterCount, erased<TYPE_CONSTRAINT_HEAD> && field_1, std::vector<erased<IC>> && field_2, erased<TYPE_CONSTRAINT_CHAIN> && field_3)
