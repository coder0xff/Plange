...
struct COMPOUND {
	...
	explicit COMPOUND
		(int32_t documentPosition, int32_t consumedCharacterCount, erased<EXPRESSION> && field_1, std::vector<erased<IC>> && field_2, parlex::detail::document::text<literal_0x7C_t> && dont_care2, std::vector<erased<IC>> && field_3, erased<EXPRESSION> && field_4)
