...
struct TUPLE {
	...
	explicit TUPLE
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_0x280x7C_t> && dont_care0, std::vector<val<IC>> && field_1, val<EXPRESSION> && field_2, std::vector<field_3_t> && field_3, std::vector<val<IC>> && field_4, parlex::detail::document::text<literal_0x7C0x29_t> && dont_care5)
