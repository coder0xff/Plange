...
struct FOR_COLLECTION {
	...
	struct declaration {
		...
		explicit declaration
			(std::optional<field_1_t> && field_1, erased<IDENTIFIER> && field_2)
			: field_1(std::move(field_1)), field_2(std::move(field_2)) {}
	...
	explicit FOR_COLLECTION
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_for_t> && dont_care0, std::vector<erased<IC>> && field_01, parlex::detail::document::text<literal_0x28_t> && dont_care2, std::vector<erased<IC>> && field_02, std::variant<
	declaration,
	erased<EXPRESSION>
> && field_03, std::vector<erased<IC>> && field_04, std::variant<
	parlex::detail::document::text<literal_in_t>,
	parlex::detail::document::text<literal_0xE20x880x88_t>
> && field_05, std::vector<erased<IC>> && field_06, erased<EXPRESSION> && collection, std::vector<erased<IC>> && field_07, parlex::detail::document::text<literal_0x29_t> && dont_care10, std::vector<erased<IC>> && field_08, erased<EXPRESSION> && invoke)
