...
struct PRE_DEC {
	...
	explicit PRE_DEC
		(int32_t documentPosition, int32_t consumedCharacterCount, parlex::detail::document::text<literal_0x2D0x2D_t> && dont_care0, std::vector<erased<IC>> && field_1, erased<EXPRESSION> && field_2)
