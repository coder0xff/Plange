...
struct THIS {
	...
	parlex::detail::document::text<literal_this_t> dontCare0;
	...
	explicit THIS(
		parlex::detail::document::text<literal_this_t> && dontCare0, std::optional<field_1_t_1_t> && field_1) : dontCare0(std::move(dontCare0)), field_1(std::move(field_1)) {}
