...
struct ENUM {
	...
	struct field_4_t_1_t {
		struct field_1_t_1_t {
			...
			explicit field_1_t_1_t(
				...
				std::vector<erased<IC>> && field_2,
				erased<ENUM_ELEMENT> && enum_element
			) : field_1(std::move(field_1)), field_2(std::move(field_2)), enum_element(std::move(enum_element)) {}
	...
	static ENUM build(parlex::details::behavior::node const & b, parlex::details::ast_node const & n);
