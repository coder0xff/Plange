...
struct RANGE_1_t {
	...
	explicit RANGE_1_t(
		parlex::details::document::text<literal_0x28_t> && dontCare0, std::vector<erased<IC>> && field_1, parlex::details::document::text<literal_0x2E0x2E0x2E_t> && dontCare2, std::vector<erased<IC>> && field_2, erased<EXPRESSION> && field_3, std::vector<erased<IC>> && field_4, std::variant<
			parlex::details::document::text<literal_0x5D_t>,
			parlex::details::document::text<literal_0x29_t>
	...
	static RANGE_1_t build(parlex::details::behavior::node const * b, parlex::details::document::walk & w);
};
...
struct RANGE_2_t {
	...
	parlex::details::document::text<literal_0x2E0x2E0x2E_t> dontCare4;
	...
	explicit RANGE_2_t(
		std::variant<
			parlex::details::document::text<literal_0x5B_t>,
			parlex::details::document::text<literal_0x28_t>
		> && field_1, std::vector<erased<IC>> && field_2, erased<EXPRESSION> && field_3, std::vector<erased<IC>> && field_4, parlex::details::document::text<literal_0x2E0x2E0x2E_t> && dontCare4, std::vector<erased<IC>> && field_5, parlex::details::document::text<literal_0x29_t> && dontCare6) : field_1(std::move(field_1)), field_2(std::move(field_2)), field_3(std::move(field_3)), field_4(std::move(field_4)), dontCare4(std::move(dontCare4)), field_5(std::move(field_5)), dontCare6(std::move(dontCare6)) {}

	RANGE_2_t(RANGE_2_t const & other) = default;
	RANGE_2_t(RANGE_2_t && move) = default;

	static RANGE_2_t build(parlex::details::behavior::node const * b, parlex::details::document::walk & w);
};
...
struct RANGE_3_t {
	...
	explicit RANGE_3_t(
		std::variant<
			parlex::details::document::text<literal_0x28_t>,
			parlex::details::document::text<literal_0x5B_t>
		> && field_01, std::vector<erased<IC>> && field_02, erased<EXPRESSION> && field_03, std::vector<erased<IC>> && field_04, parlex::details::document::text<literal_0x2E0x2E0x2E_t> && dontCare4, std::vector<erased<IC>> && field_05, erased<EXPRESSION> && field_06, std::vector<erased<IC>> && field_07, std::variant<
			parlex::details::document::text<literal_0x5D_t>,
			parlex::details::document::text<literal_0x29_t>
	...
	static RANGE_3_t build(parlex::details::behavior::node const * b, parlex::details::document::walk & w);
};
