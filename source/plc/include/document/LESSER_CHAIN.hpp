...
struct LESSER_CHAIN {
	...
	val<LESSER_CHAIN_LOOP> field_3;
	


	explicit LESSER_CHAIN
		(int32_t documentPosition, int32_t consumedCharacterCount, val<EXPRESSION> && field_1, std::vector<val<IC>> && field_2, val<LESSER_CHAIN_LOOP> && field_3)
